...
void wrapper_03759daa3eb158ec96c6b48b26f8a000()
{
    ...
    class ::Eigen::Matrix< double, 4, 1, 0, 4, 1 >  (*function_pointer_03759daa3eb158ec96c6b48b26f8a000)(class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  const &, class ::Eigen::Matrix< double, 4, 1, 0, 4, 1 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_03759daa3eb158ec96c6b48b26f8a000, "");
}