...
namespace autowig
{
    void method_decorator_f0396bd0961c54fe8bdfc896ead3effc(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 >  & param_out)
    { instance.setIdentity() = param_out; }
    void method_decorator_2abc451e04c6561abe1bd2eaaab5bda0(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 >  & param_out)
    { instance.setIdentity(param_in_0, param_in_1) = param_out; }
    void method_decorator_126c519bd704509c847bd93bae6f3643(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 >  & param_out)
    { instance.forceAlignedAccess() = param_out; }
    void method_decorator_9bc3134fec515a11a491ece982f51022(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > >  & param_out)
...
void wrapper_74cf342207655bd09eb5cedac3d9059f()
{
    ...
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, 4, 4, 0, 4, 4 > >::*method_pointer_775cbf49672955ba9d859fb5e380fd5c)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > >::stableNorm;
    ...
    class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 >  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, 4, 4, 0, 4, 4 > >::*method_pointer_90f87866b95a5eb28d23d3da1d181e30)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > >::unitOrthogonal;
    class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, 4, 4, 0, 4, 4 > >::*method_pointer_acd89474e8ea57919d212923b7a955cc)(long int , long int , long int ) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 > >::eulerAngles;
    ...
    class_74cf342207655bd09eb5cedac3d9059f.def("stable_norm", method_pointer_775cbf49672955ba9d859fb5e380fd5c, "");
    ...
    class_74cf342207655bd09eb5cedac3d9059f.def("unit_orthogonal", method_pointer_90f87866b95a5eb28d23d3da1d181e30, "");
    class_74cf342207655bd09eb5cedac3d9059f.def("euler_angles", method_pointer_acd89474e8ea57919d212923b7a955cc, "");
