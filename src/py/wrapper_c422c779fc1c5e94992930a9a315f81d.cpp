...
namespace autowig
{
    void method_decorator_edc04eda1f7250b8b067fb5aa0c7434a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_54c3a416591a572ca96e9b3d752cfe49(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_2739d49433385be2afe0d3378518b758(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_1fd41f0a445d5f47b9e3bd2e977321b4(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_a7972a50144a5d7e90fecf5bbcb7b727(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_1ef62828876350cd94e5ca923b3472e8(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_8a63c5722a9a548590b42e76b6054e99(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.x() = param_out; }
    void method_decorator_a83a2f7d594950aab2644c68a7f7917f(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.y() = param_out; }
    void method_decorator_e6e351b563cb5ec7bf4261a7a789f483(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_9d955317e75a5101a1cc907d70cbe3b3(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     struct ::std::complex< double >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 >::*method_pointer_9d955317e75a5101a1cc907d70cbe3b3)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >, 1 >::w;
...
// TODO // TODO     class_c422c779fc1c5e94992930a9a315f81d.def("w", method_pointer_9d955317e75a5101a1cc907d70cbe3b3, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_c422c779fc1c5e94992930a9a315f81d.def("w", autowig::method_decorator_9d955317e75a5101a1cc907d70cbe3b3);
