...
void wrapper_02118cc881ce5b27aa30642db3dd684e()
{
    ...
    class_02118cc881ce5b27aa30642db3dd684e.def(boost::python::init<  >(""));
    class_02118cc881ce5b27aa30642db3dd684e.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_02118cc881ce5b27aa30642db3dd684e.def(boost::python::init< struct ::std::complex< float >  const &, struct ::std::complex< float >  const &, struct ::std::complex< float >  const &, struct ::std::complex< float >  const & >(""));
    class_02118cc881ce5b27aa30642db3dd684e.def(boost::python::init< class ::Eigen::Matrix< struct ::std::complex< float >, 4, 1, 0, 4, 1 >  const & >(""));
