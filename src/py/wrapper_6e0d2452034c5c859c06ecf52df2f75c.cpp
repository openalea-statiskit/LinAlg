...
namespace autowig
{
    void method_decorator_b16c9ab4a2c85ea19ef18381132be3ba(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >  & param_out)
    { instance.base() = param_out; }
    void method_decorator_97c4dc3b11db527d909783849c85198e(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_2b0614059d895278a5d16284718a5b49(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, const float  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_e7dbd2c932ad5f0d811b2fa240124935(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, float  const & param_in_1, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_4c58e51ad77057f39e20d8368512b4b2(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, float  const & param_in_2, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
    void method_decorator_4c996fbf34415a4ab6316ae4b933c248(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setZero(param_in_0) = param_out; }
    void method_decorator_80a0d8b680f95b489930d1926fa08134(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setZero(param_in_0, param_in_1) = param_out; }
    void method_decorator_efcd755942435cada0bd5a55e0936ea6(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_403a174ea56f5490a32b8dfae18de1de(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setOnes(param_in_0, param_in_1) = param_out; }
    void method_decorator_4fb165370a1650b4a4ed002c15e0d3df(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_3aa979fe81335e00a5fc18f2884de66a(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  & param_out)
...
void wrapper_6e0d2452034c5c859c06ecf52df2f75c()
{
    ...
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >::*method_pointer_9246b7c1e9295fd1816bb5777618b3df)(long int , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >::*method_pointer_1921c7f09b2b50548b458bff26826a82)(long int , enum ::Eigen::NoChange_t ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >::*method_pointer_2cfa57926fbc502da61848fe080a87b5)(enum ::Eigen::NoChange_t , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >::conservativeResize;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 > > > > class_6e0d2452034c5c859c06ecf52df2f75c("_PlainObjectBase_6e0d2452034c5c859c06ecf52df2f75c", "", boost::python::no_init);
    ...
    class_6e0d2452034c5c859c06ecf52df2f75c.def("conservative_resize", method_pointer_9246b7c1e9295fd1816bb5777618b3df, "");
    class_6e0d2452034c5c859c06ecf52df2f75c.def("conservative_resize", method_pointer_1921c7f09b2b50548b458bff26826a82, "");
    class_6e0d2452034c5c859c06ecf52df2f75c.def("conservative_resize", method_pointer_2cfa57926fbc502da61848fe080a87b5, "");
