...
namespace autowig
{
    void method_decorator_fef333bf69cc57f1afd4b52be087ba77(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_719cc71a4c185bbdbbb055a0cade2cbf(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_d50a303842405ba88a8992e7563504b5(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_88b13e0d10235868adab2e314ae3780d(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, const float  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_991138181ff15520bb65d0f83a98ce17(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, const float  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_dd6098c0d84c560c945da2a0e3ebeb62(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, const float  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_9c40467a4ff15b64989ff1f5dda68728(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, const float  & param_out)     { instance.x() = param_out; }
    void method_decorator_5c921b74459155c2a1d7fa5865095b86(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, const float  & param_out)     { instance.y() = param_out; }
// TODO     void method_decorator_1598da026c465f69bed0080e21392d02(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, const float  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_fd2a520fa2735340b4245f2ef1647104(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 > & instance, const float  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     float  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_1598da026c465f69bed0080e21392d02)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 >::z;
// TODO // TODO     float  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_fd2a520fa2735340b4245f2ef1647104)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 2, 1, 0, 2, 1 >, 1 >::w;
...
// TODO // TODO     class_9c53a1fb2ad357e89e98f9abace640b6.def("z", method_pointer_1598da026c465f69bed0080e21392d02, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_9c53a1fb2ad357e89e98f9abace640b6.def("z", autowig::method_decorator_1598da026c465f69bed0080e21392d02);
// TODO // TODO     class_9c53a1fb2ad357e89e98f9abace640b6.def("w", method_pointer_fd2a520fa2735340b4245f2ef1647104, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_9c53a1fb2ad357e89e98f9abace640b6.def("w", autowig::method_decorator_fd2a520fa2735340b4245f2ef1647104);
