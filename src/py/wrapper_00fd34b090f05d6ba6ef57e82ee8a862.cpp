...
namespace autowig
{
    ...
    void method_decorator_ade396d211cf5f229998c86a723a43e6(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 1 > & instance, ::Eigen::Index  param_in_0, const ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 1 >::Scalar & param_out)     { instance.coeffRef(param_in_0) = param_out; }
