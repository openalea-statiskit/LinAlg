...
void wrapper_44919ff66aef53608e0cd82064ceedc8()
{
    ...
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  (*function_pointer_44919ff66aef53608e0cd82064ceedc8)(class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const &, class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const &, enum ::statiskit::linalg::solver_type  const &) = ::statiskit::linalg::solve;
