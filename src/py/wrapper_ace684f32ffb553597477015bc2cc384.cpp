...
void wrapper_ace684f32ffb553597477015bc2cc384()
{
    ...
    class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  (*function_pointer_ace684f32ffb553597477015bc2cc384)(class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  const &, class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_ace684f32ffb553597477015bc2cc384, "");
}