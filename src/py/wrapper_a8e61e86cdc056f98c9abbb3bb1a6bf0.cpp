...
namespace autowig
{
    void method_decorator_90a61371d5025609aac3abf1b5b0729e(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & param_out)     { instance.setConstant(param_in_0) = param_out; }
// TODO // TODO     void method_decorator_5ba33748ba04561d84a9e507c03329c0(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, struct ::std::complex< double >  const & param_in_1, struct ::std::complex< double >  const & param_in_2, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO // TODO // TODO     void method_decorator_c513ce73f67c5f75b04649a40803f1ad(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, struct ::std::complex< double >  const & param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1) = param_out; }
    void method_decorator_03e8a065837e5225a0ed321061d633e5(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & param_out)     { instance.setZero() = param_out; }
    void method_decorator_60add31844df512ba9119080c8cd0fc5(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & param_out)     { instance.setOnes() = param_out; }
    void method_decorator_6c60601bc96f5bba8022ce4dad8b1234(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & param_out)     { instance.setRandom() = param_out; }
    void method_decorator_e9f8ba816e5553afb8abf504f95447f8(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & param_out)     { instance.operator*=(param_in_0) = param_out; }
}
...
// TODO // TODO // TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 2, 1, 0, 2, 1 > >::*method_pointer_5ba33748ba04561d84a9e507c03329c0)(long int , struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > >::setLinSpaced;
// TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 2, 1, 0, 2, 1 > >::*method_pointer_c513ce73f67c5f75b04649a40803f1ad)(struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 > >::setLinSpaced;
...
// TODO // TODO     class_a8e61e86cdc056f98c9abbb3bb1a6bf0.def("set_lin_spaced", method_pointer_5ba33748ba04561d84a9e507c03329c0, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_a8e61e86cdc056f98c9abbb3bb1a6bf0.def("set_lin_spaced", autowig::method_decorator_5ba33748ba04561d84a9e507c03329c0);
// TODO     class_a8e61e86cdc056f98c9abbb3bb1a6bf0.def("set_lin_spaced", method_pointer_c513ce73f67c5f75b04649a40803f1ad, boost::python::return_internal_reference<>(), "");
// TODO     class_a8e61e86cdc056f98c9abbb3bb1a6bf0.def("set_lin_spaced", autowig::method_decorator_c513ce73f67c5f75b04649a40803f1ad);
