...
namespace autowig
{
    void method_decorator_c088187c1d055529857d985422469549(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_4f725f0583695a648e2dc0f79e85ff6c(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_5b5cba70f0d653d6b9c980e5654fa92f(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_01fd3ad8671354ce8254f0527b081860(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const double  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_b9d9d72394d9597ab3b93e30d1ed5ff6(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const double  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_29d6ca5d207f533ca86896c6d9995ac0(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const double  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_af17a100e388597fade168739d7b9e04(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, const double  & param_out)     { instance.x() = param_out; }
    void method_decorator_de2e88f34b0150d2b1087102afa58fac(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, const double  & param_out)     { instance.y() = param_out; }
    void method_decorator_b3a9df41b6e051228db88129c7bebf68(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, const double  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_a4b3615edc0a58e283c31654f9a657a4(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 > & instance, const double  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     double  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 >::*method_pointer_a4b3615edc0a58e283c31654f9a657a4)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 3, 1, 0, 3, 1 >, 1 >::w;
...
// TODO // TODO     class_2aaa13bc0a9e5e0e88016fe1528fe0a3.def("w", method_pointer_a4b3615edc0a58e283c31654f9a657a4, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_2aaa13bc0a9e5e0e88016fe1528fe0a3.def("w", autowig::method_decorator_a4b3615edc0a58e283c31654f9a657a4);
