...
namespace autowig
{
    void method_decorator_f36b411db3235221ad6daefd29c8f9f7(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & param_out)     { instance.setConstant(param_in_0) = param_out; }
// TODO // TODO     void method_decorator_ee02afe9d2a257d888918a63b1a6ba76(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > > & instance, long int  param_in_0, struct ::std::complex< double >  const & param_in_1, struct ::std::complex< double >  const & param_in_2, class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO // TODO // TODO     void method_decorator_7d0496880c535ffb8c7f3622bd3aa508(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, struct ::std::complex< double >  const & param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1) = param_out; }
    void method_decorator_31cb869f679e516c86fdf13c14c91632(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & param_out)     { instance.setZero() = param_out; }
    void method_decorator_ea5fc4344d4c52ceaac180b61ec8013e(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & param_out)     { instance.setOnes() = param_out; }
    void method_decorator_bab2b97672f8535c880041a26333d263(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & param_out)     { instance.setRandom() = param_out; }
    void method_decorator_04018e511a9c5da0aa20129373f93e36(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & param_out)     { instance.operator*=(param_in_0) = param_out; }
}
...
// TODO // TODO // TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, 1, 0, -1, 1 > >::*method_pointer_ee02afe9d2a257d888918a63b1a6ba76)(long int , struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > >::setLinSpaced;
// TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, 1, 0, -1, 1 > >::*method_pointer_7d0496880c535ffb8c7f3622bd3aa508)(struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, 1, 0, -1, 1 > >::setLinSpaced;
...
// TODO // TODO     class_4b639cb9c4cb5f24b86d456da721b992.def("set_lin_spaced", method_pointer_ee02afe9d2a257d888918a63b1a6ba76, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_4b639cb9c4cb5f24b86d456da721b992.def("set_lin_spaced", autowig::method_decorator_ee02afe9d2a257d888918a63b1a6ba76);
// TODO     class_4b639cb9c4cb5f24b86d456da721b992.def("set_lin_spaced", method_pointer_7d0496880c535ffb8c7f3622bd3aa508, boost::python::return_internal_reference<>(), "");
// TODO     class_4b639cb9c4cb5f24b86d456da721b992.def("set_lin_spaced", autowig::method_decorator_7d0496880c535ffb8c7f3622bd3aa508);
