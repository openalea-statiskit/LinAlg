...
namespace autowig
{
    void method_decorator_2ab232d0a0d254219c5723aa4c42bdeb(class ::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > > & instance, int  const & param_in_0, class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & param_out)     { instance.setConstant(param_in_0) = param_out; }
// TODO     void method_decorator_c05596e92fce55ac89bf9eca0ecbeca0(class ::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, int  const & param_in_1, int  const & param_in_2, class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO     void method_decorator_6073b78a49fb5bdabe0b09372bbedd9f(class ::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > > & instance, int  const & param_in_0, int  const & param_in_1, class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1) = param_out; }
    void method_decorator_bd9d64633a0f505b9118396f3e11cbfc(class ::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > > & instance, class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & param_out)     { instance.setZero() = param_out; }
    void method_decorator_7f0291501de4526dbafdb51eb22b3a09(class ::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > > & instance, class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & param_out)     { instance.setOnes() = param_out; }
    void method_decorator_1144db05bdc45bf99a9c80c5952b1653(class ::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > > & instance, class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & param_out)     { instance.setRandom() = param_out; }
    void method_decorator_ca234946eb4f5ed4bba24c1be0d4b119(class ::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > > & instance, int  const & param_in_0, class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & param_out)     { instance.operator*=(param_in_0) = param_out; }
}
...
// TODO // TODO     class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & (::Eigen::DenseBase< ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > >::*method_pointer_c05596e92fce55ac89bf9eca0ecbeca0)(long int , int  const &, int  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > >::setLinSpaced;
// TODO // TODO     class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 >  & (::Eigen::DenseBase< ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > >::*method_pointer_6073b78a49fb5bdabe0b09372bbedd9f)(int  const &, int  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< int, 3, 3, 0, 3, 3 > >::setLinSpaced;
...
// TODO // TODO     class_0742f22284cc5fb89f4a7d11086762a3.def("set_lin_spaced", method_pointer_c05596e92fce55ac89bf9eca0ecbeca0, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_0742f22284cc5fb89f4a7d11086762a3.def("set_lin_spaced", autowig::method_decorator_c05596e92fce55ac89bf9eca0ecbeca0);
// TODO // TODO     class_0742f22284cc5fb89f4a7d11086762a3.def("set_lin_spaced", method_pointer_6073b78a49fb5bdabe0b09372bbedd9f, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_0742f22284cc5fb89f4a7d11086762a3.def("set_lin_spaced", autowig::method_decorator_6073b78a49fb5bdabe0b09372bbedd9f);
