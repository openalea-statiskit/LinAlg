...
namespace autowig
{
    void method_decorator_e884698885215e719fcda2eec8232514(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >  & param_out)     { instance.base() = param_out; }
    void method_decorator_1e931ddcd59b5c2ca4d422298b965a9e(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_aab249d5fcba57fa811f018076aecb03(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, const double  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
// TODO     void method_decorator_5f399da707eb5766a7ff1c08645bb2b9(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, double  const & param_in_1, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_81ca33e9c4e257a285755e3ed3c99e51(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, long int  param_in_1, double  const & param_in_2, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO     void method_decorator_e58ca3ecfb1b5f53b6371cad2d8687bf(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setZero(param_in_0) = param_out; }
    void method_decorator_63fbd951ae3253098a41d144c5f2fd72(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setZero(param_in_0, param_in_1) = param_out; }
// TODO     void method_decorator_af7e3821815353c0834df7c968e5c771(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_33107ae92d1e5dd69a24a6016d475331(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setOnes(param_in_0, param_in_1) = param_out; }
// TODO     void method_decorator_1cf598ad585551708ef405284325957e(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_7c6bb22744d157cc95ecc08b82c4c688(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & param_out)     { instance.setRandom(param_in_0, param_in_1) = param_out; }
}
...
// TODO     class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::*method_pointer_5f399da707eb5766a7ff1c08645bb2b9)(long int , double  const &) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::setConstant;
...
// TODO     class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::*method_pointer_e58ca3ecfb1b5f53b6371cad2d8687bf)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::setZero;
...
// TODO     class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::*method_pointer_af7e3821815353c0834df7c968e5c771)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::setOnes;
...
// TODO     class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::*method_pointer_1cf598ad585551708ef405284325957e)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >::setRandom;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 4, 4, 0, 4, 4 > > >, boost::noncopyable > class_0101d2c47c6657a586b0fdaf975386be("_PlainObjectBase_0101d2c47c6657a586b0fdaf975386be", "", boost::python::no_init);
...
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_constant", method_pointer_5f399da707eb5766a7ff1c08645bb2b9, boost::python::return_internal_reference<>(), "");
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_constant", autowig::method_decorator_5f399da707eb5766a7ff1c08645bb2b9);
...
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_zero", method_pointer_e58ca3ecfb1b5f53b6371cad2d8687bf, boost::python::return_internal_reference<>(), "");
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_zero", autowig::method_decorator_e58ca3ecfb1b5f53b6371cad2d8687bf);
...
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_ones", method_pointer_af7e3821815353c0834df7c968e5c771, boost::python::return_internal_reference<>(), "");
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_ones", autowig::method_decorator_af7e3821815353c0834df7c968e5c771);
...
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_random", method_pointer_1cf598ad585551708ef405284325957e, boost::python::return_internal_reference<>(), "");
// TODO     class_0101d2c47c6657a586b0fdaf975386be.def("set_random", autowig::method_decorator_1cf598ad585551708ef405284325957e);
