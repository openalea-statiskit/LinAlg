...
namespace autowig
{
    ...
    void method_decorator_7e4e7337527e5175bc5edff290f1b4da(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > & instance, ::Eigen::Index  param_in_0, class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > & param_out)     { instance.setZero(param_in_0) = param_out; }
    ...
    void method_decorator_e014eb584e1a57f0a836046baa4f51ff(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > & instance, ::Eigen::Index  param_in_0, class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > & param_out)     { instance.setOnes(param_in_0) = param_out; }
    ...
    void method_decorator_0c53554a2e59551baf2bf2c14a43ddab(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > & instance, ::Eigen::Index  param_in_0, class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > & param_out)     { instance.setRandom(param_in_0) = param_out; }
...
void wrapper_69a4a110a0015866946de130cdeee56b()
{
    ...
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_6fee1267039c5f90af71c2c3b27f7f54)(::Eigen::Index ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::conservativeResize;
    ...
    if(autowig::Held< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::is_class)
    {
        ...
        //boost::python::objects::class_value_wrapper< autowig::Held< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::Type, boost::python::objects::make_ptr_instance< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >, boost::python::objects::pointer_holder< autowig::Held< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::Type, class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > > > >();
    }
