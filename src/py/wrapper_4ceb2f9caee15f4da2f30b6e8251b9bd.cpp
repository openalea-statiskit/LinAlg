...
namespace autowig
{
    void method_decorator_f8e8d489e02b597e8117c8d8be9bc1c0(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_03746ec8c9ed5eda89dbdd9b489debce(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_abb95f0137b9576ea589cad571ffaeac(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_192278cc557559608ab2689de64db1bd(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_2129ca9f33755ae2ae2046edca910605(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_d163a1c86a91568aa8d459c8000f25c0(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_cf784443962e56289b58b90d48cee597(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.x() = param_out; }
    void method_decorator_8b538958af2f58c789d4ac834af8caa2(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.y() = param_out; }
    void method_decorator_da85f93f82905f2989fa40b714ca6cff(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_a3ef3a65f42056c1a4cb2dcba839015e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     struct ::std::complex< float >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 >::*method_pointer_a3ef3a65f42056c1a4cb2dcba839015e)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 3, 1, 1, 3 >, 1 >::w;
...
// TODO // TODO     class_4ceb2f9caee15f4da2f30b6e8251b9bd.def("w", method_pointer_a3ef3a65f42056c1a4cb2dcba839015e, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_4ceb2f9caee15f4da2f30b6e8251b9bd.def("w", autowig::method_decorator_a3ef3a65f42056c1a4cb2dcba839015e);
