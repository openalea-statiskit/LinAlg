...
void wrapper_b8c70f1a796a55309c519b57e60d7d3f()
{
    ...
    struct ::std::complex< float >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_792ef5a5d35f5f939d54c3397266e89e)(long int ) const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::operator[];
    ...
    struct ::std::complex< float >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_683298d13dda5c67bba9dd769cde3a56)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::x;
    struct ::std::complex< float >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_72f8f134a17455d5b9662976f87233db)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::y;
    struct ::std::complex< float >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_64e7a4beb3ca52fd8f3386ed56beaf2b)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::z;
    struct ::std::complex< float >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_ece8c33223135a35ac384b1d1350c51a)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, -1, -1, 0, -1, -1 >, 0 >::w;
    ...
    class_b8c70f1a796a55309c519b57e60d7d3f.def("__getitem__", method_pointer_792ef5a5d35f5f939d54c3397266e89e, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    ...
    class_b8c70f1a796a55309c519b57e60d7d3f.def("x", method_pointer_683298d13dda5c67bba9dd769cde3a56, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_b8c70f1a796a55309c519b57e60d7d3f.def("y", method_pointer_72f8f134a17455d5b9662976f87233db, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_b8c70f1a796a55309c519b57e60d7d3f.def("z", method_pointer_64e7a4beb3ca52fd8f3386ed56beaf2b, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_b8c70f1a796a55309c519b57e60d7d3f.def("w", method_pointer_ece8c33223135a35ac384b1d1350c51a, boost::python::return_value_policy< boost::python::return_by_value >(), "");
