...
void wrapper_32d9268c82ed5cc19bc33d4ee72a3380()
{
    ...
    long int  (::Eigen::EigenBase< ::Eigen::FullPivLU< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::*method_pointer_23d36a47e6f85206a667e80613448df8)() const = &::Eigen::EigenBase< class ::Eigen::FullPivLU< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::rows;
    long int  (::Eigen::EigenBase< ::Eigen::FullPivLU< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::*method_pointer_875f087a26985ce2acf5337917042e59)() const = &::Eigen::EigenBase< class ::Eigen::FullPivLU< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::cols;
    long int  (::Eigen::EigenBase< ::Eigen::FullPivLU< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::*method_pointer_5cbaf2c47730517bbba13c8fe222a962)() const = &::Eigen::EigenBase< class ::Eigen::FullPivLU< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::size;
    boost::python::class_< struct ::Eigen::EigenBase< class ::Eigen::FullPivLU< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >, autowig::HeldType< struct ::Eigen::EigenBase< class ::Eigen::FullPivLU< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > > > > class_32d9268c82ed5cc19bc33d4ee72a3380("_EigenBase_32d9268c82ed5cc19bc33d4ee72a3380", "", boost::python::no_init);
    ...
    class_32d9268c82ed5cc19bc33d4ee72a3380.def("size", method_pointer_5cbaf2c47730517bbba13c8fe222a962, "");
