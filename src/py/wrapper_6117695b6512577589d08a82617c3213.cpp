...
namespace autowig
{
    void method_decorator_c861fb348f485444a1a1d94764d36678(class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  & param_out)     { instance.real() = param_out; }
    void method_decorator_262c7bdb17ce52158bf3c3264d8ae191(class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  & param_out)     { instance.setIdentity() = param_out; }
    void method_decorator_d75387a493f75b89bbeafbc5f8cde0eb(class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  & param_out)     { instance.setIdentity(param_in_0, param_in_1) = param_out; }
    void method_decorator_00264ea5bf1c51c8af4d6cbdca248dec(class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  & param_out)     { instance.forceAlignedAccess() = param_out; }
    void method_decorator_8a8e68457bb3557fb39619e5b0f44442(class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >  & param_out)     { instance.matrix() = param_out; }
}
...
void wrapper_6117695b6512577589d08a82617c3213()
{
    ...
    class ::Eigen::FullPivLU< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_a40092fe1d8556c9a256e28731448144)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::fullPivLu;
    class ::Eigen::PartialPivLU< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_f0f631da091f594c8ad307f41b2ee3ef)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::partialPivLu;
    class ::Eigen::PartialPivLU< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_0f1a50d2d293572a8acbbf3b19cf3bf2)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::lu;
    ...
    class ::Eigen::LLT< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >, 1 >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_e9d2dc3afcf956a6994d7918de3de6f0)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::llt;
    class ::Eigen::LDLT< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >, 1 >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_8156b25f91295c90a43728ce97515c37)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::ldlt;
    class ::Eigen::HouseholderQR< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_d88e0a0929fa54dcad5bbcff0328a86c)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::householderQr;
    class ::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_fb9c2f0a873c547e9a89a9aa99117a52)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::colPivHouseholderQr;
    class ::Eigen::FullPivHouseholderQR< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >  const (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_d141102d9f305a66933ed2cd8d057449)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::fullPivHouseholderQr;
    ...
    class ::Eigen::JacobiSVD< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >, 2 >  (::Eigen::MatrixBase< ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::*method_pointer_e5c5166a03a55bd6813ac92741f94911)(unsigned int ) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 > >::jacobiSvd;
    ...
    class_6117695b6512577589d08a82617c3213.def("full_piv_lu", method_pointer_a40092fe1d8556c9a256e28731448144, "");
    class_6117695b6512577589d08a82617c3213.def("partial_piv_lu", method_pointer_f0f631da091f594c8ad307f41b2ee3ef, "");
    class_6117695b6512577589d08a82617c3213.def("lu", method_pointer_0f1a50d2d293572a8acbbf3b19cf3bf2, "");
    class_6117695b6512577589d08a82617c3213.def("determinant", method_pointer_7efd8fef3f115767b6d04512f1cf441b, "");
    class_6117695b6512577589d08a82617c3213.def("llt", method_pointer_e9d2dc3afcf956a6994d7918de3de6f0, "");
    class_6117695b6512577589d08a82617c3213.def("ldlt", method_pointer_8156b25f91295c90a43728ce97515c37, "");
    class_6117695b6512577589d08a82617c3213.def("householder_qr", method_pointer_d88e0a0929fa54dcad5bbcff0328a86c, "");
    class_6117695b6512577589d08a82617c3213.def("col_piv_householder_qr", method_pointer_fb9c2f0a873c547e9a89a9aa99117a52, "");
    class_6117695b6512577589d08a82617c3213.def("full_piv_householder_qr", method_pointer_d141102d9f305a66933ed2cd8d057449, "");
    class_6117695b6512577589d08a82617c3213.def("eigenvalues", method_pointer_04beb89281795a07929a3e58b6f5055d, "");
    class_6117695b6512577589d08a82617c3213.def("jacobi_svd", method_pointer_e5c5166a03a55bd6813ac92741f94911, "");
