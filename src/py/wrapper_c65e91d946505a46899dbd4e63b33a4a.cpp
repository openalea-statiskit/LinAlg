...
namespace autowig
{
    void method_decorator_66277285a28a56bd8c9ac4dab2677fea(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_29d29ec1f25c5fc5b542f54f4906343e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)
    { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_36be829ebc31515191a8a32243902455(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)
    { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_d9c4d9b0fbfb55f886058417e73eb059(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_c2b326ca2d9058a9a98070ec4414feb8(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)
    { instance.operator[](param_in_0) = param_out; }
    void method_decorator_b3c0bc64ce1c5731a9e6d06ecb0e8824(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)
    { instance.operator()(param_in_0) = param_out; }
    void method_decorator_6ade43af24015e918f2c8022da2bbc84(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< float >  & param_out)
    { instance.x() = param_out; }
    void method_decorator_c4c5d6b360e5520a83877d4947922a91(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< float >  & param_out)
    { instance.y() = param_out; }
    void method_decorator_c00162f49e9f5460b8c8a852febfa83e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< float >  & param_out)
    { instance.z() = param_out; }
    void method_decorator_1016151f40d25e27a22ffa3048ace787(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< float >  & param_out)
...
void wrapper_c65e91d946505a46899dbd4e63b33a4a()
{
    ...
    struct ::std::complex< float >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_c00162f49e9f5460b8c8a852febfa83e)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 >::z;
    struct ::std::complex< float >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_1016151f40d25e27a22ffa3048ace787)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 1 >::w;
    ...
    class_c65e91d946505a46899dbd4e63b33a4a.def("z", method_pointer_c00162f49e9f5460b8c8a852febfa83e, boost::python::return_internal_reference<>(), "");
    class_c65e91d946505a46899dbd4e63b33a4a.def("z", autowig::method_decorator_c00162f49e9f5460b8c8a852febfa83e);
    class_c65e91d946505a46899dbd4e63b33a4a.def("w", method_pointer_1016151f40d25e27a22ffa3048ace787, boost::python::return_internal_reference<>(), "");
    class_c65e91d946505a46899dbd4e63b33a4a.def("w", autowig::method_decorator_1016151f40d25e27a22ffa3048ace787);
