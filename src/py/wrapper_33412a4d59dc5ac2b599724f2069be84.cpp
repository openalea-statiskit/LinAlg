...
// TODO     class_33412a4d59dc5ac2b599724f2069be84.def(boost::python::init< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Scalar const &, ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Scalar const &, ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Scalar const & >(""));
// TODO     class_33412a4d59dc5ac2b599724f2069be84.def(boost::python::init< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Scalar const &, ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Scalar const &, ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Scalar const &, ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Scalar const & >(""));
    ...
    if(std::is_class< autowig::Held< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::Type >::value)
    {
