...
namespace autowig
{
    void method_decorator_2486e303ed365ee09210adad9f8e8034(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & param_out)     { instance.setConstant(param_in_0) = param_out; }
// TODO // TODO     void method_decorator_b29641dacc3d55c4b2a3ee5f02edb741(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > > & instance, long int  param_in_0, struct ::std::complex< double >  const & param_in_1, struct ::std::complex< double >  const & param_in_2, class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO // TODO // TODO     void method_decorator_045951374a5c5acd974884f278fcd57f(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > > & instance, struct ::std::complex< double >  const & param_in_0, struct ::std::complex< double >  const & param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1) = param_out; }
    void method_decorator_b2555aae150b53c2bfd4b6acff709cab(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & param_out)     { instance.setZero() = param_out; }
    void method_decorator_30739afe94e452c284b5916b5d7c37c2(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & param_out)     { instance.setOnes() = param_out; }
    void method_decorator_94d2b5e4f2da5e2a9de477138b2d459f(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & param_out)     { instance.setRandom() = param_out; }
    void method_decorator_1e16c00daade5a1699cae0c7cc148903(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & param_out)     { instance.operator*=(param_in_0) = param_out; }
}
...
// TODO // TODO // TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 1, -1, 1, 1, -1 > >::*method_pointer_b29641dacc3d55c4b2a3ee5f02edb741)(long int , struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > >::setLinSpaced;
// TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 1, -1, 1, 1, -1 > >::*method_pointer_045951374a5c5acd974884f278fcd57f)(struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, -1, 1, 1, -1 > >::setLinSpaced;
...
// TODO // TODO     class_a2d78c86b0f65c8bb352da67061b479a.def("set_lin_spaced", method_pointer_b29641dacc3d55c4b2a3ee5f02edb741, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_a2d78c86b0f65c8bb352da67061b479a.def("set_lin_spaced", autowig::method_decorator_b29641dacc3d55c4b2a3ee5f02edb741);
// TODO     class_a2d78c86b0f65c8bb352da67061b479a.def("set_lin_spaced", method_pointer_045951374a5c5acd974884f278fcd57f, boost::python::return_internal_reference<>(), "");
// TODO     class_a2d78c86b0f65c8bb352da67061b479a.def("set_lin_spaced", autowig::method_decorator_045951374a5c5acd974884f278fcd57f);
