...
void wrapper_2f3719ffdc245a03b66d1ef28152e9ee()
{
    ...
    class_2f3719ffdc245a03b66d1ef28152e9ee.def(boost::python::init<  >(""));
    class_2f3719ffdc245a03b66d1ef28152e9ee.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_2f3719ffdc245a03b66d1ef28152e9ee.def(boost::python::init< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >  const & >(""));
