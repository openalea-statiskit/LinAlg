...
void wrapper_ebc9828c80d75c2d974c4eca04150bd1()
{
    ...
    class ::Eigen::Transpositions< -1, -1, int >  const & (::Eigen::LDLT< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::*method_pointer_d37e6eb6fd7a53bead50af6a59817843)() const = &::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::transpositionsP;
    ...
    double  (::Eigen::LDLT< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::*method_pointer_115f6597b511515385c1d34c7e497b5e)() const = &::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::rcond;
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const & (::Eigen::LDLT< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::*method_pointer_4943c3dcc62b5829b0f69508839cacf5)() const = &::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::matrixLDLT;
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  (::Eigen::LDLT< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::*method_pointer_eabe73580856515886dba190b2bc5adc)() const = &::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::reconstructedMatrix;
    ...
    long int  (::Eigen::LDLT< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::*method_pointer_f034ec7fa4bc55cfb29b07b093f5a08a)() const = &::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::rows;
    long int  (::Eigen::LDLT< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::*method_pointer_0bd184e6963f5362bbed791b177dc88d)() const = &::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >::cols;
    ...
    boost::python::class_< class ::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 >, autowig::HeldType< class ::Eigen::LDLT< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 > > > class_ebc9828c80d75c2d974c4eca04150bd1("_LDLT_ebc9828c80d75c2d974c4eca04150bd1", "", boost::python::no_init);
