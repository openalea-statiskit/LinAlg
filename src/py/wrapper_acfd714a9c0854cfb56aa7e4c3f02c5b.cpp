...
void wrapper_acfd714a9c0854cfb56aa7e4c3f02c5b()
{
    ...
    ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::CoeffReturnType  (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::*method_pointer_c91c76decf935269bad3a9841dd826bd)(::Eigen::Index , ::Eigen::Index ) const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::operator();
    ...
    ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::CoeffReturnType  (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::*method_pointer_fd470d0129355ac5850283b6fae3890a)(::Eigen::Index ) const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::operator[];
    ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::CoeffReturnType  (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::*method_pointer_750314671bda55a18153089bd9b4e14d)(::Eigen::Index ) const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 0 >::operator();
    ...
    class_acfd714a9c0854cfb56aa7e4c3f02c5b.def("__call__", method_pointer_c91c76decf935269bad3a9841dd826bd, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    ...
    class_acfd714a9c0854cfb56aa7e4c3f02c5b.def("__getitem__", method_pointer_fd470d0129355ac5850283b6fae3890a, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_acfd714a9c0854cfb56aa7e4c3f02c5b.def("__call__", method_pointer_750314671bda55a18153089bd9b4e14d, boost::python::return_value_policy< boost::python::return_by_value >(), "");
