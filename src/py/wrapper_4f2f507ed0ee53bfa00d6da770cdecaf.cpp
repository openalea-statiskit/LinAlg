...
namespace autowig
{
    void method_decorator_a107bcf8fc16503fb4277b745e5b7e3b(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_ad6ac7b7fd9055d5856636e3dee6ca81(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_1965a5689681592da68bd1871dcdb762(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< float >  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_1c29486a8e5f59b7a1d14b2b3d3117f1(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_d522d00b667e5aa7945f64cc3ce34e69(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_256932832c9a57a087b48e7afbbe127d(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, struct ::std::complex< float >  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_b870cc67601156efad4a80f1443631fb(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.x() = param_out; }
    void method_decorator_72e28f9dcee55d2896a17e0aa7154157(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.y() = param_out; }
// TODO     void method_decorator_568c580330615049a0ca794ede80deab(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_acc7e960caf35a8f98de5cd4127a3d21(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 > & instance, struct ::std::complex< float >  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     struct ::std::complex< float >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_568c580330615049a0ca794ede80deab)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 >::z;
// TODO // TODO     struct ::std::complex< float >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_acc7e960caf35a8f98de5cd4127a3d21)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 1, 2, 1, 1, 2 >, 1 >::w;
...
// TODO // TODO     class_4f2f507ed0ee53bfa00d6da770cdecaf.def("z", method_pointer_568c580330615049a0ca794ede80deab, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_4f2f507ed0ee53bfa00d6da770cdecaf.def("z", autowig::method_decorator_568c580330615049a0ca794ede80deab);
// TODO // TODO     class_4f2f507ed0ee53bfa00d6da770cdecaf.def("w", method_pointer_acc7e960caf35a8f98de5cd4127a3d21, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_4f2f507ed0ee53bfa00d6da770cdecaf.def("w", autowig::method_decorator_acc7e960caf35a8f98de5cd4127a3d21);
