...
namespace autowig
{
    void method_decorator_b3a686cd99b558a2a8d28751d7858b7b(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_c84ddb15319550dd9c1054335b554702(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_a14fbf27ef015552b3f221b58e2b3651(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_9d635b372dab5cdf94bbdcee562263d9(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_632ab844b62058cf84729e7ab9e8daaf(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_162fcffa7e0b54f2ae88cef7fa32442a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_54bc1fc8df8a5e9ca73a1a66a4a464fa(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, const int  & param_out)     { instance.x() = param_out; }
    void method_decorator_5a348237d741551d8e382c935dd33092(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, const int  & param_out)     { instance.y() = param_out; }
// TODO     void method_decorator_adc5a9f8e8db5de3929177c53b7f3f33(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, const int  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_00536df441235509b53e4f9ea593192e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 > & instance, const int  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     int  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_adc5a9f8e8db5de3929177c53b7f3f33)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 >::z;
// TODO // TODO     int  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_00536df441235509b53e4f9ea593192e)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 2, 1, 0, 2, 1 >, 1 >::w;
...
// TODO // TODO     class_8b683f12f5355fd0ada5d7b5fe13e4b7.def("z", method_pointer_adc5a9f8e8db5de3929177c53b7f3f33, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_8b683f12f5355fd0ada5d7b5fe13e4b7.def("z", autowig::method_decorator_adc5a9f8e8db5de3929177c53b7f3f33);
// TODO // TODO     class_8b683f12f5355fd0ada5d7b5fe13e4b7.def("w", method_pointer_00536df441235509b53e4f9ea593192e, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_8b683f12f5355fd0ada5d7b5fe13e4b7.def("w", autowig::method_decorator_00536df441235509b53e4f9ea593192e);
