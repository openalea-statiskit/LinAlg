...
void wrapper_ed58f062a9ec5995b704d14bc105b469()
{
    ...
    ::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::Index  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_6c4920cec75d53da96bd711abee1da60)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::nonzeroSingularValues;
    ::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::Index  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_fb65a37fee7151ac82073acd5104d832)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::rank;
    ...
    ::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::Index  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_cdf3f1e1ab9258eeb39f4e058ff28ea5)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::rows;
    ::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::Index  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_c60d3e762e0559e3920511940aadc55e)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::cols;
