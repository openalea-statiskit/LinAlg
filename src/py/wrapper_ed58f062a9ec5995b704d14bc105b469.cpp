...
namespace autowig
{
    ...
    void method_decorator_d1d5ea25c65b5b95ae1a0bc48ccb5e12(class ::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > > & instance, double  const & param_in_0, class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 >  & param_out)     { instance.setThreshold(param_in_0) = param_out; }
...
void wrapper_ed58f062a9ec5995b704d14bc105b469()
{
    ...
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const & (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_9e826c3d636d56cb95b894a3c6209b7d)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::matrixU;
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const & (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_e7b6bc621b695140ad43f242fbe08b92)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::matrixV;
    class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >  const & (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_8292465fcc7b5155acc4db7504c86421)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::singularValues;
    long int  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_6c4920cec75d53da96bd711abee1da60)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::nonzeroSingularValues;
    long int  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_fb65a37fee7151ac82073acd5104d832)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::rank;
    class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 >  & (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_d1d5ea25c65b5b95ae1a0bc48ccb5e12)(double  const &) = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::setThreshold;
    ...
    double  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_c95336ca58a15053b1a8eb33a5ea6d33)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::threshold;
    ...
    long int  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_cdf3f1e1ab9258eeb39f4e058ff28ea5)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::rows;
    long int  (::Eigen::SVDBase< ::Eigen::JacobiSVD< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::*method_pointer_c60d3e762e0559e3920511940aadc55e)() const = &::Eigen::SVDBase< class ::Eigen::JacobiSVD< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 2 > >::cols;
    ...
    class_ed58f062a9ec5995b704d14bc105b469.def("nonzero_singular_values", method_pointer_6c4920cec75d53da96bd711abee1da60, "");
    class_ed58f062a9ec5995b704d14bc105b469.def("rank", method_pointer_fb65a37fee7151ac82073acd5104d832, "");
    ...
    class_ed58f062a9ec5995b704d14bc105b469.def("rows", method_pointer_cdf3f1e1ab9258eeb39f4e058ff28ea5, "");
    class_ed58f062a9ec5995b704d14bc105b469.def("cols", method_pointer_c60d3e762e0559e3920511940aadc55e, "");
