...
void wrapper_dac260d6ea625c83b3011c9384df180c()
{
    ...
    class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >  (*function_pointer_dac260d6ea625c83b3011c9384df180c)(class ::Eigen::Matrix< struct ::std::complex< float >, 2, 2, 0, 2, 2 >  const &, class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_dac260d6ea625c83b3011c9384df180c, "");
}