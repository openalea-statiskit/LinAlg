...
namespace autowig
{
    void method_decorator_7598ff1b58c15c8799dab5ee422e261d(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_dfb1539833ff5893a1e75bbc4a443abf(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_d1757b14c00d55bebc8c5c5b1a2fd9da(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_742be038aade597c8d7be723135240a7(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const float  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_e8b596bb8f5e5eee86997e659e8631d3(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const float  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_85a6e51761e55c77b8af4436f702bd10(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const float  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_6d651c67e14f5ddb8f0550e64a9d6ccc(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, const float  & param_out)     { instance.x() = param_out; }
    void method_decorator_429914637a4e5bd9b06008122550fba7(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, const float  & param_out)     { instance.y() = param_out; }
// TODO     void method_decorator_50321e53db9e5b69b56567765a70398e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, const float  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_8b98c313c9bd52e3aafada31b7881b91(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 > & instance, const float  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     float  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_50321e53db9e5b69b56567765a70398e)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 >::z;
// TODO // TODO     float  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_8b98c313c9bd52e3aafada31b7881b91)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 1 >::w;
...
// TODO // TODO     class_afa290e2a9195051acb514eaab3c79fb.def("z", method_pointer_50321e53db9e5b69b56567765a70398e, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_afa290e2a9195051acb514eaab3c79fb.def("z", autowig::method_decorator_50321e53db9e5b69b56567765a70398e);
// TODO // TODO     class_afa290e2a9195051acb514eaab3c79fb.def("w", method_pointer_8b98c313c9bd52e3aafada31b7881b91, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_afa290e2a9195051acb514eaab3c79fb.def("w", autowig::method_decorator_8b98c313c9bd52e3aafada31b7881b91);
