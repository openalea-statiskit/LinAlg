...
namespace autowig
{
    void method_decorator_1e3a099449245056ba5f6caedf6fde7e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_f881e70b6f6f55ad8616e7309f769bfe(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)
    { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_18ac1e19a2645551ae42abf219813413(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)
    { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_991fe9c3d5ec5e13acf832af9f252010(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, const int  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_25c913a0f49d5ffa9ead7cd96480a64a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, const int  & param_out)
    { instance.operator[](param_in_0) = param_out; }
    void method_decorator_5ad6ff5dd890563783a644cb61086fec(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, const int  & param_out)
    { instance.operator()(param_in_0) = param_out; }
    void method_decorator_5d09f69c5b295e0289f41471d759db13(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, const int  & param_out)
    { instance.x() = param_out; }
    void method_decorator_cd0d2a3ceb8b53c6995a5800891d760a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, const int  & param_out)
    { instance.y() = param_out; }
    void method_decorator_e9025ec3fcbe527a9b88d3039919f8ed(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, const int  & param_out)
    { instance.z() = param_out; }
    void method_decorator_0793670c02be5953b5b4faa7a5cf2928(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 > & instance, const int  & param_out)
...
void wrapper_abddabfd134752058b2e8545283dfdc0()
{
    ...
    int  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 >::*method_pointer_0793670c02be5953b5b4faa7a5cf2928)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 3, 1, 1, 3 >, 1 >::w;
    ...
    class_abddabfd134752058b2e8545283dfdc0.def("w", method_pointer_0793670c02be5953b5b4faa7a5cf2928, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_abddabfd134752058b2e8545283dfdc0.def("w", autowig::method_decorator_0793670c02be5953b5b4faa7a5cf2928);
