...
void wrapper_75fd3edfd3465199a36ecacb38609cb0()
{
    ...
    long int  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_93823be0b363515cabd733ac64c6720a)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::nonZeros;
    long int  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_796f96533e1851dbba52009274ee47ee)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::outerSize;
    long int  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_4dc49c1bbb345f4798936cac5b0cf9c4)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::innerSize;
    void  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_3fe9f396b17e57ada96e817442366eb8)(long int ) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::resize;
    void  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_fc1b44b20212571580810a010ca98216)(long int , long int ) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::resize;
...
// TODO     class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_b4261c9cd22e5293aea1159d9c575fdb)(long int , double  const &, double  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::setLinSpaced;
// TODO     class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_2cfb4850bb805967aa58381e8bb635de)(double  const &, double  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::setLinSpaced;
    ...
    bool  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_30254a49ca9b50d88f67604c32b60ac6)(double  const &, double  const &) const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::isMuchSmallerThan;
    bool  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_bce0f51c4f7154b19822781108b9c059)(double  const &, double  const &) const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::isApproxToConstant;
    bool  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_9a61dd318e175f249b20bf00f0efde37)(double  const &, double  const &) const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::isConstant;
    bool  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_f1d008a1a32c5d28a897aed9e1a730d2)(double  const &) const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::isZero;
    bool  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_bf552c53df825979b9e085285c3c6026)(double  const &) const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::isOnes;
    ...
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_84fc10f6be7858ac936740809659ca4a)(double  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::operator*=;
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const & (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_d7a529bed6b9547bb727ff827575186c)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::eval;
    double  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_b79e588b565259379bda88f51361b5be)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::sum;
    double  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_4ca2a092bad25d13ae91a1335bf4e643)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::mean;
    double  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_275e0b51404a524fa623780e37202749)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::trace;
    double  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_81534b949ddb56139c8b21cf8dd5038d)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::prod;
    ...
    double  const & (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_4cbf2f4d26e555f98e2216875c06c58f)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::value;
    ...
    long int  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_89a6fd460a82536daba4829091ab4e35)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::count;
...
// TODO     class_75fd3edfd3465199a36ecacb38609cb0.def("set_lin_spaced", method_pointer_b4261c9cd22e5293aea1159d9c575fdb, boost::python::return_internal_reference<>(), "");
// TODO     class_75fd3edfd3465199a36ecacb38609cb0.def("set_lin_spaced", autowig::method_decorator_b4261c9cd22e5293aea1159d9c575fdb);
