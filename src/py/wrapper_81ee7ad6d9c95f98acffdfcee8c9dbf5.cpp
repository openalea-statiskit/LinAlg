...
namespace autowig
{
    void method_decorator_eb20dbd27235578b8e50c98d2934ec80(struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > & instance, class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >  & param_out)
    { instance.derived() = param_out; }
    void method_decorator_dcfe3df8f57352cdb38fcf0f61a7e13d(struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > const & instance, class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >  & param_out)
...
void wrapper_81ee7ad6d9c95f98acffdfcee8c9dbf5()
{
    ...
    long int  (::Eigen::EigenBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::*method_pointer_fde20175304e5ed4b19f22be9695b193)() const = &::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::rows;
    long int  (::Eigen::EigenBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::*method_pointer_9358856d9a665e6eb7a02c82dcd3e250)() const = &::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::cols;
    long int  (::Eigen::EigenBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::*method_pointer_289098308e445963b4b835a4673499ca)() const = &::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::size;
    ...
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def("size", method_pointer_289098308e445963b4b835a4673499ca, "");
