...
namespace autowig
{
    void method_decorator_852e8f71b901536a864cb710c8fafde0(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_5dd2b00ed728533494562b3b302494e2(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)
    { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_34784e3d451f5477a453b074c0bac5d5(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)
    { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_4d1835ced7a755bbb5d8bee5320f2b28(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, const float  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_234651606b0e5fa7a63258dec9089cd7(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, const float  & param_out)
    { instance.operator[](param_in_0) = param_out; }
    void method_decorator_20d93cc4900a5737a078eebc30eb674a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, const float  & param_out)
    { instance.operator()(param_in_0) = param_out; }
    void method_decorator_43c0d86b308555ba9f0c311c4607a7af(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, const float  & param_out)
    { instance.x() = param_out; }
    void method_decorator_8187cb8e46ed525497a9d64e5b8d49d0(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, const float  & param_out)
    { instance.y() = param_out; }
    void method_decorator_cb6f64ddbb1a56a0a6ba9eb2fdba5c69(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, const float  & param_out)
    { instance.z() = param_out; }
    void method_decorator_fc3ebd4ee3c35f2d89852af685d4123f(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 > & instance, const float  & param_out)
...
void wrapper_45b012f761c45a67a8ebf09b44e918cb()
{
    ...
    float  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 >::*method_pointer_fc3ebd4ee3c35f2d89852af685d4123f)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 3, 1, 1, 3 >, 1 >::w;
    ...
    class_45b012f761c45a67a8ebf09b44e918cb.def("w", method_pointer_fc3ebd4ee3c35f2d89852af685d4123f, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_45b012f761c45a67a8ebf09b44e918cb.def("w", autowig::method_decorator_fc3ebd4ee3c35f2d89852af685d4123f);
