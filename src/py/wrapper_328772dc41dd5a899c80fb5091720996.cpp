...
namespace autowig
{
    void method_decorator_09bb2ed506715981851d6c3d7989b6b9(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setIdentity() = param_out; }
    void method_decorator_6aa466256d265d509b5beb1292347c59(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setIdentity(param_in_0, param_in_1) = param_out; }
    void method_decorator_6f596f0261815396af7685ef17648dba(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.forceAlignedAccess() = param_out; }
    void method_decorator_0f51e04c6e5c5f30bc548ca9abbbbda1(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >  & param_out)
...
void wrapper_328772dc41dd5a899c80fb5091720996()
{
    ...
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_592f4956e2fe5cca8d594adb3fba105f)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::stableNorm;
    ...
    class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_e825fe8da0bb5b99b619572f0c55ad6a)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::unitOrthogonal;
    class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_2aaa0bd5cfdc584b9f6fc29e65b208cb)(long int , long int , long int ) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::eulerAngles;
    ...
    class_328772dc41dd5a899c80fb5091720996.def("stable_norm", method_pointer_592f4956e2fe5cca8d594adb3fba105f, "");
    ...
    class_328772dc41dd5a899c80fb5091720996.def("unit_orthogonal", method_pointer_e825fe8da0bb5b99b619572f0c55ad6a, "");
    class_328772dc41dd5a899c80fb5091720996.def("euler_angles", method_pointer_2aaa0bd5cfdc584b9f6fc29e65b208cb, "");
