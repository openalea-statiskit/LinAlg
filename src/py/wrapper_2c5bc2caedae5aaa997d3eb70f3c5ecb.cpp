...
void wrapper_2c5bc2caedae5aaa997d3eb70f3c5ecb()
{
    ...
    class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 >  (*function_pointer_2c5bc2caedae5aaa997d3eb70f3c5ecb)(class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 >  const &, class ::Eigen::Matrix< struct ::std::complex< double >, 4, 4, 0, 4, 4 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_2c5bc2caedae5aaa997d3eb70f3c5ecb, "");
}