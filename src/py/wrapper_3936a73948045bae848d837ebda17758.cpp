...
namespace autowig
{
    void method_decorator_ac3d518ed1c9506097740de2814971c1(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >  & param_out)
    { instance.base() = param_out; }
    void method_decorator_81116597106d5e30b9e1e68b76afbfc7(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_9efd1cb2383650e7a603617d59567130(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, const double  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_3e12ff9a59885270a45ecc87f11cefe1(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, double  const & param_in_1, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_dc1ca5c8df3858eeaa89832a0be191ff(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, long int  param_in_1, double  const & param_in_2, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
    void method_decorator_e439d713e169508dbdb9414ada5e0f27(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
    { instance.setZero(param_in_0) = param_out; }
    void method_decorator_a4efa95e481c5c1c9fdc8fc6d4bf2421(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
    { instance.setZero(param_in_0, param_in_1) = param_out; }
    void method_decorator_e23818c0268e5af8a579c9f4374fe274(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
    { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_19ada7677c3f53139f492ff0face3e5c(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
    { instance.setOnes(param_in_0, param_in_1) = param_out; }
    void method_decorator_344552907f065ef5b3fd187fb4323443(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
    { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_6d9115d5832f5071a7849283d66c73c5(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 >  & param_out)
...
void wrapper_3936a73948045bae848d837ebda17758()
{
    ...
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >::*method_pointer_b06a89f0d3c55064b90733fc0970fa15)(long int , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >::*method_pointer_c4504203b64c588d83cc3f48ca9a3de2)(long int , enum ::Eigen::NoChange_t ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >::*method_pointer_10c80ec94c9459dfb814cb74521ca1ff)(enum ::Eigen::NoChange_t , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >::conservativeResize;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 2, 1, 0, 2, 1 > > > > class_3936a73948045bae848d837ebda17758("_PlainObjectBase_3936a73948045bae848d837ebda17758", "", boost::python::no_init);
    ...
    class_3936a73948045bae848d837ebda17758.def("conservative_resize", method_pointer_b06a89f0d3c55064b90733fc0970fa15, "");
    class_3936a73948045bae848d837ebda17758.def("conservative_resize", method_pointer_c4504203b64c588d83cc3f48ca9a3de2, "");
    class_3936a73948045bae848d837ebda17758.def("conservative_resize", method_pointer_10c80ec94c9459dfb814cb74521ca1ff, "");
