...
namespace autowig
{
    void method_decorator_27d9aca3cf365759b4a1a40b71adaa0f(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >  & param_out)
    { instance.base() = param_out; }
    void method_decorator_050966a2db815fed9772e0123ecc0164(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_d40b38501e6558159446fb4c9524755e(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, const double  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_ae876db314e654dda85c246ade80a0d8(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, double  const & param_in_1, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_dc56965b41625251b6d99e4c2e974d9c(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, double  const & param_in_2, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
    void method_decorator_a51db7abe7fb52b793ec11277bb5825d(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setZero(param_in_0) = param_out; }
    void method_decorator_304ed043cd9059058827cfa6fc5789dd(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setZero(param_in_0, param_in_1) = param_out; }
    void method_decorator_7a7bdec5ff9f5f67b472580c4951ef03(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_bc356d7e86505bf59e39f44a68f70ad4(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setOnes(param_in_0, param_in_1) = param_out; }
    void method_decorator_615b7e9c00df52c3b2076137dbbb31ce(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
    { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_4b2d9df6b00552febb22b88ab0391ba3(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)
...
void wrapper_99a3aea4224d53c982d1e589e456541f()
{
    ...
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >::*method_pointer_9b6d0fbbf8a65fbdb5b16b923a823b81)(long int , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >::*method_pointer_7b7a47b33e18514e9bc1828ec680758f)(long int , enum ::Eigen::NoChange_t ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >::*method_pointer_8bc6c02d02bc5e72b872cb974297732c)(enum ::Eigen::NoChange_t , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >::conservativeResize;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > > > class_99a3aea4224d53c982d1e589e456541f("_PlainObjectBase_99a3aea4224d53c982d1e589e456541f", "", boost::python::no_init);
    ...
    class_99a3aea4224d53c982d1e589e456541f.def("conservative_resize", method_pointer_9b6d0fbbf8a65fbdb5b16b923a823b81, "");
    class_99a3aea4224d53c982d1e589e456541f.def("conservative_resize", method_pointer_7b7a47b33e18514e9bc1828ec680758f, "");
    class_99a3aea4224d53c982d1e589e456541f.def("conservative_resize", method_pointer_8bc6c02d02bc5e72b872cb974297732c, "");
