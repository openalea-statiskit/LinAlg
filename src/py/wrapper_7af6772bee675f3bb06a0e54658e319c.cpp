...
void wrapper_7af6772bee675f3bb06a0e54658e319c()
{
    ...
    class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  (*function_pointer_7af6772bee675f3bb06a0e54658e319c)(class ::Eigen::Matrix< struct ::std::complex< double >, 3, 3, 0, 3, 3 >  const &, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_7af6772bee675f3bb06a0e54658e319c, "");
}