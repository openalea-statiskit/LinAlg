...
void wrapper_b1ba60543280539bba23e0b80afbdad9()
{
    ...
    class_b1ba60543280539bba23e0b80afbdad9.def(boost::python::init<  >(""));
    class_b1ba60543280539bba23e0b80afbdad9.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_b1ba60543280539bba23e0b80afbdad9.def(boost::python::init< class ::Eigen::Matrix< float, 1, -1, 1, 1, -1 >  const & >(""));
