...
namespace autowig
{
    void method_decorator_d58c71f36d355c36a2c10aa760804348(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_f86c719cb42d5b1cbef613578eee83a1(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_19011eba6d33543ab7c09ee93b36f5c2(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_f1ed011c65cf525fba9c85855160e46f(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const double  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_2cc81c534a9550db905edb92ec2af389(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const double  & param_out)
    { instance.operator[](param_in_0) = param_out; }
    void method_decorator_3cabda9059065c3e953b483907b4fff3(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const double  & param_out)
    { instance.operator()(param_in_0) = param_out; }
    void method_decorator_51de8b0aeddb565b9fbab5a0e72663bf(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, const double  & param_out)
    { instance.x() = param_out; }
    void method_decorator_cf9574195bf2556fba89a44339556419(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, const double  & param_out)
    { instance.y() = param_out; }
    void method_decorator_a844262adfc254f3883a578ec39f854a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, const double  & param_out)
    { instance.z() = param_out; }
    void method_decorator_8ee9cf85a703520d8baee0612ec75431(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 > & instance, const double  & param_out)
...
void wrapper_d0c61a4f1b09525cbc0a9955e8a3797a()
{
    ...
    double  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_a844262adfc254f3883a578ec39f854a)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 >::z;
    double  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_8ee9cf85a703520d8baee0612ec75431)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >, 1 >::w;
    ...
    class_d0c61a4f1b09525cbc0a9955e8a3797a.def("z", method_pointer_a844262adfc254f3883a578ec39f854a, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_d0c61a4f1b09525cbc0a9955e8a3797a.def("z", autowig::method_decorator_a844262adfc254f3883a578ec39f854a);
    class_d0c61a4f1b09525cbc0a9955e8a3797a.def("w", method_pointer_8ee9cf85a703520d8baee0612ec75431, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_d0c61a4f1b09525cbc0a9955e8a3797a.def("w", autowig::method_decorator_8ee9cf85a703520d8baee0612ec75431);
