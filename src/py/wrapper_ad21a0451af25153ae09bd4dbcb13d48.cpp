...
namespace autowig
{
    void method_decorator_a48a4aa3bad85517b0c87ae27c78dbb4(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_06675bc3f2e15ed498d78a239e6951a2(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)
    { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_44ef0e199c0c5eb5b851a9e3d0d4d6d8(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)
    { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_01003f936ae85aa6ab18b4507246636a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const float  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_e7fb940e776d5a0f9c43e80a0e752918(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const float  & param_out)
    { instance.operator[](param_in_0) = param_out; }
    void method_decorator_f5a2e17b22145237a23a5dd573a30914(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const float  & param_out)
    { instance.operator()(param_in_0) = param_out; }
    void method_decorator_41f8f9fb4ab852639a143b65b73c8b00(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, const float  & param_out)
    { instance.x() = param_out; }
    void method_decorator_83c996c9a8465ab8993790e0fcc39f83(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, const float  & param_out)
    { instance.y() = param_out; }
    void method_decorator_9d6933dac670588bb1bb81654da5d484(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, const float  & param_out)
    { instance.z() = param_out; }
    void method_decorator_ec16ce09d774508190a9d9d2f53d42ac(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 > & instance, const float  & param_out)
...
void wrapper_ad21a0451af25153ae09bd4dbcb13d48()
{
    ...
    float  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 >::*method_pointer_ec16ce09d774508190a9d9d2f53d42ac)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >, 1 >::w;
    ...
    class_ad21a0451af25153ae09bd4dbcb13d48.def("w", method_pointer_ec16ce09d774508190a9d9d2f53d42ac, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_ad21a0451af25153ae09bd4dbcb13d48.def("w", autowig::method_decorator_ec16ce09d774508190a9d9d2f53d42ac);
