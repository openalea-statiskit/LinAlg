...
void wrapper_258d8c6003cf569a93f70cf7bdb7ffe4()
{
    ...
    class_258d8c6003cf569a93f70cf7bdb7ffe4.def(boost::python::init<  >(""));
    class_258d8c6003cf569a93f70cf7bdb7ffe4.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_258d8c6003cf569a93f70cf7bdb7ffe4.def(boost::python::init< class ::Eigen::Matrix< float, 2, 2, 0, 2, 2 >  const & >(""));
