...
void wrapper_a39638c9bb845e37b857b60bdbedc688()
{
    ...
    class ::Eigen::Matrix< struct ::std::complex< float >, -1, 1, 0, -1, 1 >  (*function_pointer_a39638c9bb845e37b857b60bdbedc688)(class ::Eigen::Matrix< struct ::std::complex< float >, -1, -1, 0, -1, -1 >  const &, class ::Eigen::Matrix< struct ::std::complex< float >, -1, 1, 0, -1, 1 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_a39638c9bb845e37b857b60bdbedc688, "");
}