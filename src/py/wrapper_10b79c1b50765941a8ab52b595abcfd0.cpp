...
namespace autowig
{
    void method_decorator_dc22f721eeca512e91511a745985cc75(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_0fc9173eeb5c528fa3cd6c390224865f(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_5a1fd4fe40c7586883a54b1c50ea11a1(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_9d41c5b565885a37b6a25bfbebdc56d4(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_4299abffe8bb5258911c1c6352f1d1d6(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_3a421eb0b0a25dbeaaa125409f2f9728(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_a1580351f82e5e9e9bd1a2aa728956e1(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.x() = param_out; }
    void method_decorator_f4536ac289805383b000db80df02e323(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.y() = param_out; }
    void method_decorator_64cfe67611f351958ecef46b64dbce08(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_7dafb59f8a07562faa0a3c7ec1262335(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     struct ::std::complex< double >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 >::*method_pointer_7dafb59f8a07562faa0a3c7ec1262335)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 3, 1, 1, 3 >, 1 >::w;
...
// TODO // TODO     class_10b79c1b50765941a8ab52b595abcfd0.def("w", method_pointer_7dafb59f8a07562faa0a3c7ec1262335, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_10b79c1b50765941a8ab52b595abcfd0.def("w", autowig::method_decorator_7dafb59f8a07562faa0a3c7ec1262335);
