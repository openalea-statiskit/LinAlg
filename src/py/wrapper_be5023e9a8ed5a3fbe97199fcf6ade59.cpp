...
namespace autowig
{
    void method_decorator_43b414420d2755529ed3bd67fbcc368c(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >  & param_out)     { instance.base() = param_out; }
    void method_decorator_b69ad31437d4501ea913313b9f068ab9(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_8ff4b043c019522bb247fc4cd4dd1160(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, const double  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
// TODO     void method_decorator_affed7c7286b5dbfa475513742f4a0e7(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, double  const & param_in_1, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_f6e542021b8459b39f683d433a056cd0(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, double  const & param_in_2, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO     void method_decorator_0a4ba82ad9bf54148156f7c3e137e312(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setZero(param_in_0) = param_out; }
    void method_decorator_a82718997a93540aa427131a067929f8(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setZero(param_in_0, param_in_1) = param_out; }
// TODO // TODO     void method_decorator_ac46e75ee6aa5dcb893cd16ae1e123f2(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_70e2524fefcf5c3a858d558696b946e5(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setOnes(param_in_0, param_in_1) = param_out; }
// TODO     void method_decorator_8282625941e75b8da1e06d8d89a80369(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_889daf522d65524fbd02e79046920165(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & param_out)     { instance.setRandom(param_in_0, param_in_1) = param_out; }
}
...
// TODO     class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::*method_pointer_affed7c7286b5dbfa475513742f4a0e7)(long int , double  const &) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::setConstant;
...
// TODO     class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::*method_pointer_0a4ba82ad9bf54148156f7c3e137e312)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::setZero;
...
// TODO     class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::*method_pointer_ac46e75ee6aa5dcb893cd16ae1e123f2)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::setOnes;
...
// TODO     class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::*method_pointer_8282625941e75b8da1e06d8d89a80369)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >::setRandom;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 3, 3, 0, 3, 3 > > >, boost::noncopyable > class_be5023e9a8ed5a3fbe97199fcf6ade59("_PlainObjectBase_be5023e9a8ed5a3fbe97199fcf6ade59", "", boost::python::no_init);
...
// TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_constant", method_pointer_affed7c7286b5dbfa475513742f4a0e7, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_constant", autowig::method_decorator_affed7c7286b5dbfa475513742f4a0e7);
...
// TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_zero", method_pointer_0a4ba82ad9bf54148156f7c3e137e312, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_zero", autowig::method_decorator_0a4ba82ad9bf54148156f7c3e137e312);
...
// TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_ones", method_pointer_ac46e75ee6aa5dcb893cd16ae1e123f2, boost::python::return_internal_reference<>(), "");
// TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_ones", autowig::method_decorator_ac46e75ee6aa5dcb893cd16ae1e123f2);
...
// TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_random", method_pointer_8282625941e75b8da1e06d8d89a80369, boost::python::return_internal_reference<>(), "");
// TODO     class_be5023e9a8ed5a3fbe97199fcf6ade59.def("set_random", autowig::method_decorator_8282625941e75b8da1e06d8d89a80369);
