...
namespace autowig
{
    void method_decorator_5a1bc44452c7535e834e4a6fba16076b(class ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > & instance, ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Scalar const & param_in_0, class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > & param_out)     { instance.setConstant(param_in_0) = param_out; }
    void method_decorator_b8717af0fa01566d8699051d16560097(class ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > & instance, ::Eigen::Index  param_in_0, ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Scalar const & param_in_1, ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Scalar const & param_in_2, class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > & param_out)     { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
    ...
    void method_decorator_87b4e3512d3d5cf4a7d7750af9ef2be8(class ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > & instance, ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Scalar const & param_in_0, class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > & param_out)     { instance.operator*=(param_in_0) = param_out; }
}
...
void wrapper_e3eac3c0866e52c2b8ebc04ab597d6d5()
{
    ...
    void  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::*method_pointer_4e6273b76315593bac2e89b1f69d1f2c)(::Eigen::Index ) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::resize;
    void  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::*method_pointer_6812928d7ce259b7a83fbd4cd5e80c21)(::Eigen::Index , ::Eigen::Index ) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::resize;
    ...
    class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > & (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::*method_pointer_b8717af0fa01566d8699051d16560097)(::Eigen::Index , ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Scalar const &, ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Scalar const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::setLinSpaced;
    ...
    ::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Scalar  (::Eigen::DenseBase< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::*method_pointer_a653d4714fba5350aa35117be6720e98)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::trace;
    ...
    class_e3eac3c0866e52c2b8ebc04ab597d6d5.def("resize", method_pointer_4e6273b76315593bac2e89b1f69d1f2c, "");
    class_e3eac3c0866e52c2b8ebc04ab597d6d5.def("resize", method_pointer_6812928d7ce259b7a83fbd4cd5e80c21, "");
    ...
    class_e3eac3c0866e52c2b8ebc04ab597d6d5.def("set_lin_spaced", method_pointer_b8717af0fa01566d8699051d16560097, boost::python::return_internal_reference<>(), "");
    class_e3eac3c0866e52c2b8ebc04ab597d6d5.def("set_lin_spaced", autowig::method_decorator_b8717af0fa01566d8699051d16560097);
