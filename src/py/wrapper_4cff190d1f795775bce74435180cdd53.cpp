...
void wrapper_4cff190d1f795775bce74435180cdd53()
{
    ...
    class_4cff190d1f795775bce74435180cdd53.def(boost::python::init<  >(""));
    class_4cff190d1f795775bce74435180cdd53.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_4cff190d1f795775bce74435180cdd53.def(boost::python::init< class ::Eigen::Matrix< double, 2, 2, 0, 2, 2 >  const & >(""));
