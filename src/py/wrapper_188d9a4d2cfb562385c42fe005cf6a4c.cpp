...
void wrapper_188d9a4d2cfb562385c42fe005cf6a4c()
{
    ...
    long int  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_bf27f693997c5cd1bd6b0ee4ed88e63b)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::diagonalSize;
    class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >  const & (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_b1739ec0fe9b50279eae0fc36fd2ce15)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::conjugate;
    class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >  const & (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_1ee01396c8245cae9c843ad389c0046f)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::real;
    class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >  & (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_9f3116f2a8c05d22a71eda0fd8fdb5f5)() = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::real;
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_6369d2847d475b9bb03dd13f1bae51f5)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::squaredNorm;
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_1b5bf3d31a8654729fc3ba85b53e7851)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::norm;
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_3eb2e32ba44e5ea7b694884ad4190ebe)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::stableNorm;
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_318a9edcebde516dbd5d4cae7673a08b)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::blueNorm;
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_d98b3daa7d585011959588dff33994ba)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::hypotNorm;
    class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >  const (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_34e1bb29a73a5302aabcb6da6fc2267c)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::normalized;
    class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >  const (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_07b99237a8965cc0843154685d178adc)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::stableNormalized;
    ...
    class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >  & (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_22d32bfd6c635510a02afd967240a041)(long int , long int ) = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::setIdentity;
    bool  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_231b9c20f88f5112b9cfbae51948753b)(double  const &) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::isIdentity;
    bool  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_f0ddd4ff84e5529097c503433929acdb)(double  const &) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::isDiagonal;
    bool  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_7eea48c623545711a3cdca5bddfda47d)(double  const &) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::isUpperTriangular;
    bool  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_c37f4f8feda35a05b56f16a671fcd87c)(double  const &) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::isLowerTriangular;
    bool  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_af985f9bd6dd5718bc2bff1e29455662)(double  const &) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::isUnitary;
    ...
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_5f16942f2bb15a39bc8bcc0bb875004c)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::trace;
    ...
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("set_identity", method_pointer_22d32bfd6c635510a02afd967240a041, boost::python::return_internal_reference<>(), "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("set_identity", autowig::method_decorator_22d32bfd6c635510a02afd967240a041);
    ...
    {
        boost::python::implicitly_convertible< autowig::HeldType< class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > >, autowig::HeldType< class ::Eigen::DenseBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > > >();
    }
