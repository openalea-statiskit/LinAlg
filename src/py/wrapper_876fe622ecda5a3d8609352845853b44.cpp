...
namespace autowig
{
    void method_decorator_399130d8f8f857bda489dd6aa8f65bfc(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >  & param_out)
    { instance.base() = param_out; }
    void method_decorator_fe5838ec7dce5eb99aa76b79abc3f79a(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_6428d91820855722868f8835c5afb841(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, const int  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_8c10a7c09181538791dd7078492fb296(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, int  const & param_in_1, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_29a745cc45be5293823b48a102783a0d(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, long int  param_in_1, int  const & param_in_2, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
    { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
    void method_decorator_fa14caf7b75b5d999168e44e65de205f(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
    { instance.setZero(param_in_0) = param_out; }
    void method_decorator_e4ebe511bdaf5ee0844be786adf7917f(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
    { instance.setZero(param_in_0, param_in_1) = param_out; }
    void method_decorator_6aaa30a5d1c5578181a9b76d12b31d54(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
    { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_2a59ea29d33a53e68f5312c958e27fe3(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
    { instance.setOnes(param_in_0, param_in_1) = param_out; }
    void method_decorator_d453b985bd755f6aaa645ab6d7269c04(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
    { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_0290dd0fd5c6568eb59beabb9944367f(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >  & param_out)
...
void wrapper_876fe622ecda5a3d8609352845853b44()
{
    ...
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >::*method_pointer_be2c5ff684565723be87218f01d874d9)(long int , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >::*method_pointer_dcfaf2007db95e0789ace2408e44a44a)(long int , enum ::Eigen::NoChange_t ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >::conservativeResize;
    void  (::Eigen::PlainObjectBase< ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >::*method_pointer_abdc66b8da135de9b6fd1a0b357090ba)(enum ::Eigen::NoChange_t , long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >::conservativeResize;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 > > > > class_876fe622ecda5a3d8609352845853b44("_PlainObjectBase_876fe622ecda5a3d8609352845853b44", "", boost::python::no_init);
    ...
    class_876fe622ecda5a3d8609352845853b44.def("conservative_resize", method_pointer_be2c5ff684565723be87218f01d874d9, "");
    class_876fe622ecda5a3d8609352845853b44.def("conservative_resize", method_pointer_dcfaf2007db95e0789ace2408e44a44a, "");
    class_876fe622ecda5a3d8609352845853b44.def("conservative_resize", method_pointer_abdc66b8da135de9b6fd1a0b357090ba, "");
