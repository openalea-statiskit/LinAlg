...
void wrapper_3e74b0aa6bab57b699aeef6be1ac97fb()
{
    ...
    class_3e74b0aa6bab57b699aeef6be1ac97fb.def(boost::python::init<  >(""));
    class_3e74b0aa6bab57b699aeef6be1ac97fb.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_3e74b0aa6bab57b699aeef6be1ac97fb.def(boost::python::init< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  const & >(""));
