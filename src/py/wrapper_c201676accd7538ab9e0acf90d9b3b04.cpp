...
void wrapper_c201676accd7538ab9e0acf90d9b3b04()
{
    ...
    class_c201676accd7538ab9e0acf90d9b3b04.def(boost::python::init<  >(""));
    class_c201676accd7538ab9e0acf90d9b3b04.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_c201676accd7538ab9e0acf90d9b3b04.def(boost::python::init< class ::Eigen::Matrix< struct ::std::complex< float >, 4, 4, 0, 4, 4 >  const & >(""));
