...
void wrapper_f0614b45082b5d40a7cd4c4881a68aff()
{
    ...
    int  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_cd3791ab85ad55babcb7436ea5f5bf36)(long int ) const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::operator[];
    ...
    int  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_826c9439dbbc5a55b6a659c612e72c91)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::x;
    int  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_bb3a8714a59654d3af3d85cc3095ee98)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::y;
    int  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_33e367fa3774543aa453069d86ca9d80)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::z;
    int  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::*method_pointer_4caff05147775e16b0b78f5f90d8af4e)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, -1, -1, 0, -1, -1 >, 0 >::w;
    ...
    class_f0614b45082b5d40a7cd4c4881a68aff.def("__getitem__", method_pointer_cd3791ab85ad55babcb7436ea5f5bf36, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    ...
    class_f0614b45082b5d40a7cd4c4881a68aff.def("x", method_pointer_826c9439dbbc5a55b6a659c612e72c91, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_f0614b45082b5d40a7cd4c4881a68aff.def("y", method_pointer_bb3a8714a59654d3af3d85cc3095ee98, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_f0614b45082b5d40a7cd4c4881a68aff.def("z", method_pointer_33e367fa3774543aa453069d86ca9d80, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_f0614b45082b5d40a7cd4c4881a68aff.def("w", method_pointer_4caff05147775e16b0b78f5f90d8af4e, boost::python::return_value_policy< boost::python::return_by_value >(), "");
