...
namespace autowig
{
    void method_decorator_89dcce2742f25591b6b3825efbeef092(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 >  & param_out)
    { instance.setIdentity() = param_out; }
    void method_decorator_3fc6912566625063961c261dcbf4ebf4(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 >  & param_out)
    { instance.setIdentity(param_in_0, param_in_1) = param_out; }
    void method_decorator_6455dba2822657f1a88cbecab494d806(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 >  & param_out)
    { instance.forceAlignedAccess() = param_out; }
    void method_decorator_c04a250afbe95284aae5c6123db458de(class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > >  & param_out)
...
void wrapper_c278a88782ad5bdaacf6474cb06db99e()
{
    ...
    double  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, 2, 2, 0, 2, 2 > >::*method_pointer_46b6657e02f153efb26b9f92b55713ca)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > >::stableNorm;
    ...
    class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 >  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, 2, 2, 0, 2, 2 > >::*method_pointer_725a4147a861593ab533bd066dd59f7b)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > >::unitOrthogonal;
    class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  (::Eigen::MatrixBase< ::Eigen::Matrix< ::std::complex< double >, 2, 2, 0, 2, 2 > >::*method_pointer_be77dd1bbf135b7d99d815935e7832f3)(long int , long int , long int ) const = &::Eigen::MatrixBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 2, 0, 2, 2 > >::eulerAngles;
    ...
    class_c278a88782ad5bdaacf6474cb06db99e.def("stable_norm", method_pointer_46b6657e02f153efb26b9f92b55713ca, "");
    ...
    class_c278a88782ad5bdaacf6474cb06db99e.def("unit_orthogonal", method_pointer_725a4147a861593ab533bd066dd59f7b, "");
    class_c278a88782ad5bdaacf6474cb06db99e.def("euler_angles", method_pointer_be77dd1bbf135b7d99d815935e7832f3, "");
