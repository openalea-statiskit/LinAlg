...
namespace autowig
{
    void method_decorator_d0fa6c6bce62510883de0bb6fa134315(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & param_out)     { instance.setConstant(param_in_0) = param_out; }
// TODO // TODO     void method_decorator_a166583f53325a81b9b3cf22936bac9e(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > > & instance, long int  param_in_0, struct ::std::complex< double >  const & param_in_1, struct ::std::complex< double >  const & param_in_2, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO // TODO // TODO     void method_decorator_b47c8154b9e15661bd34dab20a3710f5(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, struct ::std::complex< double >  const & param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1) = param_out; }
    void method_decorator_055b7484e8015f139cccc51561b5682a(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & param_out)     { instance.setZero() = param_out; }
    void method_decorator_67c1bc8f45095c9a89ce763644255cd4(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & param_out)     { instance.setOnes() = param_out; }
    void method_decorator_c8e93e01ea2b5681a350d2478ae15917(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & param_out)     { instance.setRandom() = param_out; }
    void method_decorator_cdff03bdb84058c6b6470753fc645064(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & param_out)     { instance.operator*=(param_in_0) = param_out; }
}
...
// TODO // TODO // TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 3, 1, 0, 3, 1 > >::*method_pointer_a166583f53325a81b9b3cf22936bac9e)(long int , struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > >::setLinSpaced;
// TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 3, 1, 0, 3, 1 > >::*method_pointer_b47c8154b9e15661bd34dab20a3710f5)(struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 1, 0, 3, 1 > >::setLinSpaced;
...
// TODO // TODO     class_3885dc584dd45390a37fdadd36f8bc0e.def("set_lin_spaced", method_pointer_a166583f53325a81b9b3cf22936bac9e, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_3885dc584dd45390a37fdadd36f8bc0e.def("set_lin_spaced", autowig::method_decorator_a166583f53325a81b9b3cf22936bac9e);
// TODO     class_3885dc584dd45390a37fdadd36f8bc0e.def("set_lin_spaced", method_pointer_b47c8154b9e15661bd34dab20a3710f5, boost::python::return_internal_reference<>(), "");
// TODO     class_3885dc584dd45390a37fdadd36f8bc0e.def("set_lin_spaced", autowig::method_decorator_b47c8154b9e15661bd34dab20a3710f5);
