...
namespace autowig
{
    void method_decorator_4f421ae118a1562ab4e952c596553d1d(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_10911bbf1f025da5bc957a957d5e88d7(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_cc96b69a4f455abf85cb240b08140c9c(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_aa709da8584d5b128c257249f06cbec1(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_a3148c98f5e450809be968ec59b743dd(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_53b7eee2bc38581c9d872c6f7ae99b79(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_6d6ee7b154af57fc928cc6a4cbdb62b6(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, const int  & param_out)     { instance.x() = param_out; }
    void method_decorator_2b33efb3ffa259babda746dc0c5ebdbe(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, const int  & param_out)     { instance.y() = param_out; }
// TODO     void method_decorator_262a2cdead345f89b51f8b9a0535bb10(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, const int  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_afb8e0f1abe15131b391489378e4b8f3(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 > & instance, const int  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     int  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_262a2cdead345f89b51f8b9a0535bb10)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 >::z;
// TODO // TODO     int  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 >::*method_pointer_afb8e0f1abe15131b391489378e4b8f3)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 1, 2, 1, 1, 2 >, 1 >::w;
...
// TODO // TODO     class_57c8ab18f56e5a4ea7b995efcfbd6915.def("z", method_pointer_262a2cdead345f89b51f8b9a0535bb10, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_57c8ab18f56e5a4ea7b995efcfbd6915.def("z", autowig::method_decorator_262a2cdead345f89b51f8b9a0535bb10);
// TODO // TODO     class_57c8ab18f56e5a4ea7b995efcfbd6915.def("w", method_pointer_afb8e0f1abe15131b391489378e4b8f3, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_57c8ab18f56e5a4ea7b995efcfbd6915.def("w", autowig::method_decorator_afb8e0f1abe15131b391489378e4b8f3);
