...
namespace autowig
{
    void method_decorator_7f96fc82dfc35292bf47daeef59736ba(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_ca95327e02d45fd4925e312427bd9b89(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_d85d90cb367f55e7a37d6520ef4fff1e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_91c0705966a75a89be4f9baef49d037c(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_137bd07ef8555acfa7f8b2b2cb9c7561(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_1f9a0dc016cf582994625ff4ae10c3e7(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, long int  param_in_0, const int  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_9d127016ded653a2ac26835f12d85f29(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, const int  & param_out)     { instance.x() = param_out; }
    void method_decorator_7e7577e6593e59619c9ddc5c069517ec(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, const int  & param_out)     { instance.y() = param_out; }
    void method_decorator_10eb63da755653adb87443ee9a35c5be(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, const int  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_84de30b922825cf0a6c2b26e8562db2b(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 > & instance, const int  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     int  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 >::*method_pointer_84de30b922825cf0a6c2b26e8562db2b)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< int, 3, 1, 0, 3, 1 >, 1 >::w;
...
// TODO // TODO     class_62db05b451ab5f74b7dba5922d71875a.def("w", method_pointer_84de30b922825cf0a6c2b26e8562db2b, boost::python::return_value_policy< boost::python::return_by_value >(), "");
// TODO // TODO     class_62db05b451ab5f74b7dba5922d71875a.def("w", autowig::method_decorator_84de30b922825cf0a6c2b26e8562db2b);
