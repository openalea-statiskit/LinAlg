...
void wrapper_d5e375870db75ec6b982049ac449ef13()
{
    ...
    class ::Eigen::Matrix< struct ::std::complex< float >, 3, 3, 0, 3, 3 >  (*function_pointer_d5e375870db75ec6b982049ac449ef13)(class ::Eigen::Matrix< struct ::std::complex< float >, 3, 3, 0, 3, 3 >  const &, class ::Eigen::Matrix< struct ::std::complex< float >, 3, 3, 0, 3, 3 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_d5e375870db75ec6b982049ac449ef13, "");
}