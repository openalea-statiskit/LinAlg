...
void wrapper_bdc023da3a49502fb7b382021b378d64()
{
    ...
    struct ::std::complex< float >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, 2, 1, 0, 2, 1 >, 0 >::*method_pointer_2e90b27f1fdf56a9a31c59c06349959b)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 0 >::z;
    struct ::std::complex< float >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< float >, 2, 1, 0, 2, 1 >, 0 >::*method_pointer_3e96ac11ca055224bfa2d60d71a6cb6e)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >, 0 >::w;
    ...
    class_bdc023da3a49502fb7b382021b378d64.def("z", method_pointer_2e90b27f1fdf56a9a31c59c06349959b, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_bdc023da3a49502fb7b382021b378d64.def("w", method_pointer_3e96ac11ca055224bfa2d60d71a6cb6e, boost::python::return_value_policy< boost::python::return_by_value >(), "");
