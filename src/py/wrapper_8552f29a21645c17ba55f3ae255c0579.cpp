...
void wrapper_8552f29a21645c17ba55f3ae255c0579()
{
    ...
    class_8552f29a21645c17ba55f3ae255c0579.def(boost::python::init<  >(""));
    class_8552f29a21645c17ba55f3ae255c0579.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_8552f29a21645c17ba55f3ae255c0579.def(boost::python::init< float  const &, float  const &, float  const & >(""));
    class_8552f29a21645c17ba55f3ae255c0579.def(boost::python::init< class ::Eigen::Matrix< float, 3, 1, 0, 3, 1 >  const & >(""));
