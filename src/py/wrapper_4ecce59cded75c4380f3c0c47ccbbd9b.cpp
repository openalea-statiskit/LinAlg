...
void wrapper_4ecce59cded75c4380f3c0c47ccbbd9b()
{
    ...
    class_4ecce59cded75c4380f3c0c47ccbbd9b.def(boost::python::init<  >(""));
    class_4ecce59cded75c4380f3c0c47ccbbd9b.def(boost::python::init< struct ::Eigen::internal::constructor_without_unaligned_array_assert  >(""));
    class_4ecce59cded75c4380f3c0c47ccbbd9b.def(boost::python::init< class ::Eigen::Matrix< struct ::std::complex< float >, 2, 1, 0, 2, 1 >  const & >(""));
