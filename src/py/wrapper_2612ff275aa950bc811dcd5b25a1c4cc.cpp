...
namespace autowig
{
    void method_decorator_81d91164d6115360a1b4c017fc04048a(class ::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > & instance, double  const & param_in_0, class ::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >  & param_out)     { instance.setThreshold(param_in_0) = param_out; }
...
void wrapper_2612ff275aa950bc811dcd5b25a1c4cc()
{
    ...
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const & (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_a2ce72d45e3e5a6982a2bbf4c4218719)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::matrixQR;
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const & (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_2737ef525db15399b4ba7c53b9c13d5b)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::matrixR;
    class ::Eigen::PermutationMatrix< -1, -1, int >  const & (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_75f5e5fcbf9252e8945bd9fca464b49c)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::colsPermutation;
    ...
    long int  (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_117f833092b65bbab47128cddd529923)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::rank;
    long int  (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_92abffc5ec055e98b3b0d487986e9f27)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::dimensionOfKernel;
    ...
    long int  (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_72d029d768d75097a7359f8216b545be)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::rows;
    long int  (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_5d57a53a2c7350d486fd414e5c6405fa)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::cols;
    class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >  const & (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_e8f759350ac2575894cf9a773e9590d5)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::hCoeffs;
    class ::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >  & (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_81d91164d6115360a1b4c017fc04048a)(double  const &) = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::setThreshold;
    ...
    double  (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_b282b4387de957a48f49f51cd82524c7)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::threshold;
    long int  (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_b93f6542f94457898d61cbcfea57e232)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::nonzeroPivots;
    double  (::Eigen::ColPivHouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_8db625acdb9953979a31ab19e066846a)() const = &::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::maxPivot;
    ...
    boost::python::class_< class ::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >, autowig::HeldType< class ::Eigen::ColPivHouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > > > class_2612ff275aa950bc811dcd5b25a1c4cc("_ColPivHouseholderQR_2612ff275aa950bc811dcd5b25a1c4cc", "", boost::python::no_init);
    class_2612ff275aa950bc811dcd5b25a1c4cc.def(boost::python::init<  >(""));
    class_2612ff275aa950bc811dcd5b25a1c4cc.def(boost::python::init< long int , long int  >(""));
