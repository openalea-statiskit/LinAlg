...
// TODO void  (::Eigen::SparseVector< double, 0, int >::*method_pointer_4fa7b50583f25e919c85490578a11121)(::Eigen::Index )= &::Eigen::SparseVector< double, 0, int >::startFill;
// TODO // TODO ::Eigen::SparseVector< double, 0, int >::Scalar & (::Eigen::SparseVector< double, 0, int >::*method_pointer_9b585adbb9b954c1a170526694f9d3c1)(::Eigen::Index , ::Eigen::Index )= &::Eigen::SparseVector< double, 0, int >::fill;
// TODO ::Eigen::SparseVector< double, 0, int >::Scalar & (::Eigen::SparseVector< double, 0, int >::*method_pointer_4285131989da54199af6c3fc09ac0fc6)(::Eigen::Index )= &::Eigen::SparseVector< double, 0, int >::fill;
// TODO // TODO ::Eigen::SparseVector< double, 0, int >::Scalar & (::Eigen::SparseVector< double, 0, int >::*method_pointer_4d69194514d95b0c9d0202ee94817de1)(::Eigen::Index , ::Eigen::Index )= &::Eigen::SparseVector< double, 0, int >::fillrand;
// TODO ::Eigen::SparseVector< double, 0, int >::Scalar & (::Eigen::SparseVector< double, 0, int >::*method_pointer_335a9e8069335079b382f4824f21810f)(::Eigen::Index )= &::Eigen::SparseVector< double, 0, int >::fillrand;
// TODO void  (::Eigen::SparseVector< double, 0, int >::*method_pointer_06ca0cbc11cb5714b41d67eff0e2cd24)()= &::Eigen::SparseVector< double, 0, int >::endFill;
// TODO ::Eigen::SparseVector< double, 0, int >::Storage & (::Eigen::SparseVector< double, 0, int >::*method_pointer_1b5fe23c88f95a74add9817ee5fca906)()= &::Eigen::SparseVector< double, 0, int >::_data;
// TODO ::Eigen::SparseVector< double, 0, int >::Storage const & (::Eigen::SparseVector< double, 0, int >::*method_pointer_46b8c75369cb535597006f5326e8bc9e)()const= &::Eigen::SparseVector< double, 0, int >::_data;
...
// TODO     void method_decorator_9b585adbb9b954c1a170526694f9d3c1(class ::Eigen::SparseVector< double, 0, int > & instance, ::Eigen::Index  param_in_0, ::Eigen::Index  param_in_1, double param_out) { instance.fill(param_in_0, param_in_1) = param_out; }
// TODO     void method_decorator_4285131989da54199af6c3fc09ac0fc6(class ::Eigen::SparseVector< double, 0, int > & instance, ::Eigen::Index  param_in_0, double param_out) { instance.fill(param_in_0) = param_out; }
// TODO     void method_decorator_4d69194514d95b0c9d0202ee94817de1(class ::Eigen::SparseVector< double, 0, int > & instance, ::Eigen::Index  param_in_0, ::Eigen::Index  param_in_1, double param_out) { instance.fillrand(param_in_0, param_in_1) = param_out; }
// TODO     void method_decorator_335a9e8069335079b382f4824f21810f(class ::Eigen::SparseVector< double, 0, int > & instance, ::Eigen::Index  param_in_0, double param_out) { instance.fillrand(param_in_0) = param_out; }
// TODO     void method_decorator_1b5fe23c88f95a74add9817ee5fca906(class ::Eigen::SparseVector< double, 0, int > & instance, const ::Eigen::SparseVector< double, 0, int >::Storage & param_out) { instance._data() = param_out; }
}
...
void wrapper_89a1f4bc90b95adda2461ec1574670e0(pybind11::module& module)
{
    ...
    pybind11::class_<class ::Eigen::SparseVector< double, 0, int >, autowig::HolderType< class ::Eigen::SparseVector< double, 0, int > >::Type, class ::Eigen::SparseCompressedBase< class ::Eigen::SparseVector< double, 0, int > > > class_89a1f4bc90b95adda2461ec1574670e0(module, "_SparseVector_89a1f4bc90b95adda2461ec1574670e0", "");
    class_89a1f4bc90b95adda2461ec1574670e0.def(pybind11::init<  >());
    class_89a1f4bc90b95adda2461ec1574670e0.def(pybind11::init< ::Eigen::Index  >());
    class_89a1f4bc90b95adda2461ec1574670e0.def(pybind11::init< ::Eigen::Index , ::Eigen::Index  >());
    class_89a1f4bc90b95adda2461ec1574670e0.def(pybind11::init< class ::Eigen::SparseVector< double, 0, int > const & >());
    class_89a1f4bc90b95adda2461ec1574670e0.def("__iadd__", method_pointer_fae50732d08a599d9b36bd1abd51ba7b, pybind11::return_value_policy::reference_internal, "");
    class_89a1f4bc90b95adda2461ec1574670e0.def("__iadd__", autowig::method_decorator_fae50732d08a599d9b36bd1abd51ba7b);
    class_89a1f4bc90b95adda2461ec1574670e0.def("__isub__", method_pointer_5a611c4cf5555163af48a3e2f2387c06, pybind11::return_value_policy::reference_internal, "");
    ...
    class_89a1f4bc90b95adda2461ec1574670e0.def("data", method_pointer_ce43605ab9c95afcad1484e764affc93, pybind11::return_value_policy::reference_internal, ":Return Type:\n    :cpp:any:`::Eigen::internal::CompressedStorage<` double,\n    int >\n\n");
    class_89a1f4bc90b95adda2461ec1574670e0.def("data", autowig::method_decorator_ce43605ab9c95afcad1484e764affc93);
    class_89a1f4bc90b95adda2461ec1574670e0.def("data", method_pointer_648d35aa6c6251528c765d788a681e6d, pybind11::return_value_policy::copy, ":Return Type:\n    :cpp:any:`::Eigen::internal::CompressedStorage<` double,\n    int >\n\n");
    ...
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert_back_by_outer_inner", method_pointer_6459be0640885540bf06a9fe1ea35e24, pybind11::return_value_policy::copy, "");
    ...
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert_back", method_pointer_a9c83c131d1c549682a04a39bc38123f, pybind11::return_value_policy::copy, "");
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert_back", autowig::method_decorator_a9c83c131d1c549682a04a39bc38123f);
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert_back_by_outer_inner_unordered", method_pointer_6e677ac51bcb5ebc9cc20c9569ebacdb, pybind11::return_value_policy::copy, "");
    ...
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert_back_unordered", method_pointer_b3a87e12cb2d58da95fc677ffe3e97a0, pybind11::return_value_policy::copy, "");
    ...
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert", method_pointer_696eaf5f69265b2997ff9f087c0b622b, pybind11::return_value_policy::copy, "");
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert", autowig::method_decorator_696eaf5f69265b2997ff9f087c0b622b);
    class_89a1f4bc90b95adda2461ec1574670e0.def("insert", method_pointer_4a667508cd495edab0aa013828b0dbd3, pybind11::return_value_policy::copy, "");
...
// TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("start_fill", method_pointer_4fa7b50583f25e919c85490578a11121, ":Parameter:\n    `reserve` (:cpp:any:`long` int) - Undocumented\n\n:Return Type:\n    :cpp:any:`void`\n\n");
// TODO // TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fill", method_pointer_9b585adbb9b954c1a170526694f9d3c1, pybind11::return_value_policy::copy, ":Parameters:\n  - `r` (:cpp:any:`long` int) - Undocumented\n  - `c` (:cpp:any:`long` int) - Undocumented\n\n:Return Type:\n    :cpp:any:`double`\n\n");
// TODO // TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fill", autowig::method_decorator_9b585adbb9b954c1a170526694f9d3c1);
// TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fill", method_pointer_4285131989da54199af6c3fc09ac0fc6, pybind11::return_value_policy::copy, ":Parameter:\n    `i` (:cpp:any:`long` int) - Undocumented\n\n:Return Type:\n    :cpp:any:`double`\n\n");
// TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fill", autowig::method_decorator_4285131989da54199af6c3fc09ac0fc6);
// TODO // TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fillrand", method_pointer_4d69194514d95b0c9d0202ee94817de1, pybind11::return_value_policy::copy, ":Parameters:\n  - `r` (:cpp:any:`long` int) - Undocumented\n  - `c` (:cpp:any:`long` int) - Undocumented\n\n:Return Type:\n    :cpp:any:`double`\n\n");
// TODO // TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fillrand", autowig::method_decorator_4d69194514d95b0c9d0202ee94817de1);
// TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fillrand", method_pointer_335a9e8069335079b382f4824f21810f, pybind11::return_value_policy::copy, ":Parameter:\n    `i` (:cpp:any:`long` int) - Undocumented\n\n:Return Type:\n    :cpp:any:`double`\n\n");
// TODO // TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("fillrand", autowig::method_decorator_335a9e8069335079b382f4824f21810f);
// TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("end_fill", method_pointer_06ca0cbc11cb5714b41d67eff0e2cd24, ":Return Type:\n    :cpp:any:`void`\n\n");
// TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("data", method_pointer_1b5fe23c88f95a74add9817ee5fca906, pybind11::return_value_policy::reference_internal, ":Return Type:\n    :cpp:any:`::Eigen::internal::CompressedStorage<` double,\n    int >\n\n");
// TODO // TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("data", autowig::method_decorator_1b5fe23c88f95a74add9817ee5fca906);
// TODO     class_89a1f4bc90b95adda2461ec1574670e0.def("data", method_pointer_46b8c75369cb535597006f5326e8bc9e, pybind11::return_value_policy::copy, ":Return Type:\n    :cpp:any:`::Eigen::internal::CompressedStorage<` double,\n    int >\n\n");
    class_89a1f4bc90b95adda2461ec1574670e0.def("__lshift__", function_group::function_2a7689b0292f582998a943e008dc9fc9, pybind11::return_value_policy::reference, "");
