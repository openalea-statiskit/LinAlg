...
void wrapper_b036397122165e73844d0603f6968fb1()
{
    ...
    class_b036397122165e73844d0603f6968fb1.def(boost::python::init< class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 0 > const & >(""));
    class_b036397122165e73844d0603f6968fb1.def(boost::python::init<  >(""));
