...
namespace autowig
{
    ...
    void method_decorator_595c6b6fb76253589933fe1a1bab9727(class ::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > & instance, ::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::MatrixType const & param_in_0, const class ::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > & param_out) { instance.compute(param_in_0) = param_out; }
}
...
void wrapper_afe331da4a5453b7a4e8518767008816()
{
    ...
    class ::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > & (::Eigen::HouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_595c6b6fb76253589933fe1a1bab9727)(::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::MatrixType const &) = &::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::compute;
    ...
    ::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::Index  (::Eigen::HouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_98fc866b0ad15b499db03313e90b7b03)() const = &::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::rows;
    ::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::Index  (::Eigen::HouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_30c55c2c2f585ece8b050cdcea2d67b9)() const = &::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::cols;
    ...
    class_afe331da4a5453b7a4e8518767008816.def("compute", method_pointer_595c6b6fb76253589933fe1a1bab9727, boost::python::return_internal_reference<>(), "");
    class_afe331da4a5453b7a4e8518767008816.def("compute", autowig::method_decorator_595c6b6fb76253589933fe1a1bab9727);
