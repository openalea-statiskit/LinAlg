...
void wrapper_582003aac6505a6d9ea4c4fa99329e5e()
{
    ...
    ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >::Index  (::Eigen::Matrix< double, -1, 1, 0, -1, 1 >::*method_pointer_b56afc7a8c2353ab883944457788298f)() const = &::Eigen::Matrix< double, -1, 1, 0, -1, 1 >::innerStride;
    ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >::Index  (::Eigen::Matrix< double, -1, 1, 0, -1, 1 >::*method_pointer_992f8240a80759b49f02e38fcc77710b)() const = &::Eigen::Matrix< double, -1, 1, 0, -1, 1 >::outerStride;
    ...
    boost::python::class_< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, autowig::Held< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >::Type > class_582003aac6505a6d9ea4c4fa99329e5e("_Matrix_582003aac6505a6d9ea4c4fa99329e5e", "", boost::python::no_init);
    ...
    class_582003aac6505a6d9ea4c4fa99329e5e.def(boost::python::init< ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >::Index  >(""));
