...
void wrapper_fa561dcf99ae51d9a4938dd504893c40()
{
    ...
    class_fa561dcf99ae51d9a4938dd504893c40.def(boost::python::init< class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 3 > const & >(""));
    class_fa561dcf99ae51d9a4938dd504893c40.def(boost::python::init<  >(""));
