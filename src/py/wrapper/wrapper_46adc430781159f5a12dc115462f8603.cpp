...
void wrapper_46adc430781159f5a12dc115462f8603()
{
    ...
    class_46adc430781159f5a12dc115462f8603.def(boost::python::init< class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 3 > const & >(""));
    class_46adc430781159f5a12dc115462f8603.def(boost::python::init<  >(""));
