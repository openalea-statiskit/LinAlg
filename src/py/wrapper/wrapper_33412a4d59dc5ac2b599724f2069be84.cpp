...
void wrapper_33412a4d59dc5ac2b599724f2069be84()
{
    ...
    ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Index  (::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::*method_pointer_29ad5c75651e5bfca25c9ed2fe07208f)() const = &::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::innerStride;
    ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Index  (::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::*method_pointer_11c42683f43052dfad6288abded43253)() const = &::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::outerStride;
    ...
    boost::python::class_< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >, autowig::Held< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::Type > class_33412a4d59dc5ac2b599724f2069be84("_Matrix_33412a4d59dc5ac2b599724f2069be84", "", boost::python::no_init);
    ...
    class_33412a4d59dc5ac2b599724f2069be84.def(boost::python::init< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >::Index  >(""));
