...
void wrapper_c701e18a94ff5af0ba968c74cfa122d8()
{
    ...
    boost::python::class_< class ::Eigen::SparseCompressedBase< class ::Eigen::SparseVector< double, 0, int > >, autowig::Held< class ::Eigen::SparseCompressedBase< class ::Eigen::SparseVector< double, 0, int > > >::Type > class_c701e18a94ff5af0ba968c74cfa122d8("_SparseCompressedBase_c701e18a94ff5af0ba968c74cfa122d8", "", boost::python::no_init);
