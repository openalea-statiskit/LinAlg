...
namespace autowig
{
    ...
    void method_decorator_19fabfb9459d5ad2862c2873c540ba25(class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > & instance, class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > const & param_in_0, const class ::Eigen::SparseVector< double, 0, int > & param_out) { instance.operator+=(param_in_0) = param_out; }
    void method_decorator_487ee0face035213b4f54426f0f9e8e1(class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > & instance, class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > const & param_in_0, const class ::Eigen::SparseVector< double, 0, int > & param_out) { instance.operator-=(param_in_0) = param_out; }
}
...
void wrapper_04bc95afc11254deb3e5e7033a554bf6()
{
    ...
    ::Eigen::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_1e63a407032059098f592e55fd05a6a3)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::rows;
    ::Eigen::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_cf2e06fa7dc457b1be95ca974c75e2d6)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::cols;
    ::Eigen::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_5d2ec637722955688a09a7ad4f719ac0)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::size;
    ...
    ::Eigen::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_af218330954254e9a77bb655c861d459)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::outerSize;
    ::Eigen::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_def9d7b1420652dfaafdc56fc86f3b5e)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::innerSize;
    ...
    ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::DenseMatrixType  (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_be2b9aeec0955699984281b80100dcb2)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::toDense;
    ...
    class ::Eigen::SparseVector< double, 0, int > & (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_19fabfb9459d5ad2862c2873c540ba25)(class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > const &) = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::operator+=;
    class ::Eigen::CwiseBinaryOp< struct ::Eigen::internal::scalar_sum_op< double, double >, class ::Eigen::SparseVector< double, 0, int > const, class ::Eigen::SparseVector< double, 0, int > const > const (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_f1f0373c229a562aade28e105a6c0b99)(class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > const &) const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::operator+;
    class ::Eigen::SparseVector< double, 0, int > & (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_487ee0face035213b4f54426f0f9e8e1)(class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > const &) = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::operator-=;
    class ::Eigen::CwiseBinaryOp< struct ::Eigen::internal::scalar_difference_op< double, double >, class ::Eigen::SparseVector< double, 0, int > const, class ::Eigen::SparseVector< double, 0, int > const > const (::Eigen::SparseMatrixBase< ::Eigen::SparseVector< double, 0, int > >::*method_pointer_fa06d7ae28875b1a8f708555ebee8516)(class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > const &) const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >::operator-;
    ...
    boost::python::class_< class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > >, autowig::Held< class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > >::Type, boost::python::bases< struct ::Eigen::EigenBase< class ::Eigen::SparseVector< double, 0, int > > > > class_04bc95afc11254deb3e5e7033a554bf6("_SparseMatrixBase_04bc95afc11254deb3e5e7033a554bf6", "", boost::python::no_init);
    class_04bc95afc11254deb3e5e7033a554bf6.def(boost::python::init<  >(""));
    class_04bc95afc11254deb3e5e7033a554bf6.def(boost::python::init< class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > const & >(""));
    ...
    class_04bc95afc11254deb3e5e7033a554bf6.def("__iadd__", method_pointer_19fabfb9459d5ad2862c2873c540ba25, boost::python::return_internal_reference<>(), "");
    class_04bc95afc11254deb3e5e7033a554bf6.def("__iadd__", autowig::method_decorator_19fabfb9459d5ad2862c2873c540ba25);
    class_04bc95afc11254deb3e5e7033a554bf6.def("__add__", method_pointer_f1f0373c229a562aade28e105a6c0b99, "");
    class_04bc95afc11254deb3e5e7033a554bf6.def("__isub__", method_pointer_487ee0face035213b4f54426f0f9e8e1, boost::python::return_internal_reference<>(), "");
    class_04bc95afc11254deb3e5e7033a554bf6.def("__isub__", autowig::method_decorator_487ee0face035213b4f54426f0f9e8e1);
    class_04bc95afc11254deb3e5e7033a554bf6.def("__sub__", method_pointer_fa06d7ae28875b1a8f708555ebee8516, "");
    ...
    {
        boost::python::implicitly_convertible< autowig::Held< class ::Eigen::SparseMatrixBase< class ::Eigen::SparseVector< double, 0, int > > >::Type, autowig::Held< struct ::Eigen::EigenBase< class ::Eigen::SparseVector< double, 0, int > > >::Type >();
    }
