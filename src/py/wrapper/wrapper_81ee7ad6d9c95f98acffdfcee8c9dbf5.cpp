...
namespace autowig {
    void method_decorator_eb20dbd27235578b8e50c98d2934ec80(struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > & instance, const class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > & param_out) { instance.derived() = param_out; }
    void method_decorator_dcfe3df8f57352cdb38fcf0f61a7e13d(struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > const & instance, const class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > & param_out) { instance.const_cast_derived() = param_out; }
}

void wrapper_81ee7ad6d9c95f98acffdfcee8c9dbf5(pybind11::module& module)
{

    pybind11::class_<struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > >, autowig::HolderType< struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > >::Type > class_81ee7ad6d9c95f98acffdfcee8c9dbf5(module, "_EigenBase_81ee7ad6d9c95f98acffdfcee8c9dbf5", "");
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def(pybind11::init< struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 > > const & >());
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def(pybind11::init<  >());
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def("derived", method_pointer_eb20dbd27235578b8e50c98d2934ec80, pybind11::return_value_policy::reference_internal, "");
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def("derived", autowig::method_decorator_eb20dbd27235578b8e50c98d2934ec80);
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def("derived", method_pointer_d92db36e6be4583d8ea61ce28355f7b7, pybind11::return_value_policy::copy, "");
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def("const_cast_derived", method_pointer_dcfe3df8f57352cdb38fcf0f61a7e13d, pybind11::return_value_policy::reference_internal, "");
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def("const_cast_derived", autowig::method_decorator_dcfe3df8f57352cdb38fcf0f61a7e13d);
    class_81ee7ad6d9c95f98acffdfcee8c9dbf5.def("const_derived", method_pointer_168318e2e41e56e8bd2462209f0f4c85, pybind11::return_value_policy::copy, "");
