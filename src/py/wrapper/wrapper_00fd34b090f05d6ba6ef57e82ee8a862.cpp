...
void wrapper_00fd34b090f05d6ba6ef57e82ee8a862()
{
    ...
    class_00fd34b090f05d6ba6ef57e82ee8a862.def(boost::python::init< class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >, 1 > const & >(""));
    class_00fd34b090f05d6ba6ef57e82ee8a862.def(boost::python::init<  >(""));
