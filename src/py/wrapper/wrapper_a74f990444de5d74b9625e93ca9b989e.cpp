...
void wrapper_a74f990444de5d74b9625e93ca9b989e()
{
    ...
    ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseMatrix< double, 0, int > >::*method_pointer_28c336e280865ca087d32aa6321207a1)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::rows;
    ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseMatrix< double, 0, int > >::*method_pointer_9c3e310fa1c052f59e926673b7986b9a)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::cols;
    ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseMatrix< double, 0, int > >::*method_pointer_997b64a3bdb051468dcd8de9e071da07)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::size;
    ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseMatrix< double, 0, int > >::*method_pointer_ea2650c6eb68556b980a0d3d6331cbee)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::nonZeros;
    ...
    ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseMatrix< double, 0, int > >::*method_pointer_7e6707dfe8395fd89a0bf458023b176b)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::outerSize;
    ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::Index  (::Eigen::SparseMatrixBase< ::Eigen::SparseMatrix< double, 0, int > >::*method_pointer_a102691f750953369aa92b37e6624a9b)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::innerSize;
    ...
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  (::Eigen::SparseMatrixBase< ::Eigen::SparseMatrix< double, 0, int > >::*method_pointer_b924b25b026c57a08160de8f02989e8d)() const = &::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >::toDense;
    ...
    boost::python::class_< class ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > >, autowig::Held< class ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > > >::Type, boost::python::bases< struct ::Eigen::internal::special_scalar_op_base< class ::Eigen::SparseMatrix< double, 0, int >, double, double, struct ::Eigen::EigenBase< class ::Eigen::SparseMatrix< double, 0, int > >, false > > > class_a74f990444de5d74b9625e93ca9b989e("_SparseMatrixBase_a74f990444de5d74b9625e93ca9b989e", "", boost::python::no_init);
    ...
    class_a74f990444de5d74b9625e93ca9b989e.def("non_zeros", method_pointer_ea2650c6eb68556b980a0d3d6331cbee, "");
    ...
    {
        boost::python::implicitly_convertible< autowig::Held< class ::Eigen::SparseMatrixBase< class ::Eigen::SparseMatrix< double, 0, int > > >::Type, autowig::Held< struct ::Eigen::internal::special_scalar_op_base< class ::Eigen::SparseMatrix< double, 0, int >, double, double, struct ::Eigen::EigenBase< class ::Eigen::SparseMatrix< double, 0, int > >, false > >::Type >();
    }
