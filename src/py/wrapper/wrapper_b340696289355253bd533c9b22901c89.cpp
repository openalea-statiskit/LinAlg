...
void wrapper_b340696289355253bd533c9b22901c89()
{
    ...
    class_b340696289355253bd533c9b22901c89.def(boost::python::init< class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 >, 0 > const & >(""));
    class_b340696289355253bd533c9b22901c89.def(boost::python::init<  >(""));
