...
void wrapper_ef3a9184ff095382ae59f98b7ee1ca0e()
{
    ...
    class_ef3a9184ff095382ae59f98b7ee1ca0e.def(boost::python::init< class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >, 1 > const & >(""));
    class_ef3a9184ff095382ae59f98b7ee1ca0e.def(boost::python::init<  >(""));
