...
void wrapper_4c0d89cd71ea55ae91d655e0dc1e1317()
{
    ...
    boost::python::class_< struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >, autowig::Held< struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > >::Type > class_4c0d89cd71ea55ae91d655e0dc1e1317("_EigenBase_4c0d89cd71ea55ae91d655e0dc1e1317", "", boost::python::no_init);
    class_4c0d89cd71ea55ae91d655e0dc1e1317.def(boost::python::init< struct ::Eigen::EigenBase< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > > const & >(""));
    class_4c0d89cd71ea55ae91d655e0dc1e1317.def(boost::python::init<  >(""));
