...
namespace autowig {
    void method_decorator_9f3116f2a8c05d22a71eda0fd8fdb5f5(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > & instance, const ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::NonConstRealReturnType  param_out) { instance.real() = param_out; }
    void method_decorator_98ad7e6dda285fe29a37cd0d97687f76(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > & instance, const class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > & param_out) { instance.setIdentity() = param_out; }
    void method_decorator_22d32bfd6c635510a02afd967240a041(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > & instance, ::Eigen::Index  param_in_0, ::Eigen::Index  param_in_1, const class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > & param_out) { instance.setIdentity(param_in_0, param_in_1) = param_out; }
    void method_decorator_06840a3e23a7526d8ba22a531bc93d38(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > & instance, const class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > & param_out) { instance.forceAlignedAccess() = param_out; }
    void method_decorator_0e2e904fbba256629a3383e363838541(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > & instance, const class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > & param_out) { instance.matrix() = param_out; }
}

void wrapper_188d9a4d2cfb562385c42fe005cf6a4c(pybind11::module& module)
{

    pybind11::class_<class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >, autowig::HolderType< class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > >::Type, class ::Eigen::DenseBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > > class_188d9a4d2cfb562385c42fe005cf6a4c(module, "_MatrixBase_188d9a4d2cfb562385c42fe005cf6a4c", "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def(pybind11::init< class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > const & >());
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("diagonal_size", method_pointer_bf27f693997c5cd1bd6b0ee4ed88e63b, "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("conjugate", method_pointer_b1739ec0fe9b50279eae0fc36fd2ce15, pybind11::return_value_policy::copy, "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("real", method_pointer_1ee01396c8245cae9c843ad389c0046f, pybind11::return_value_policy::copy, "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("real", method_pointer_9f3116f2a8c05d22a71eda0fd8fdb5f5, pybind11::return_value_policy::reference_internal, "");
    ...
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("set_identity", method_pointer_98ad7e6dda285fe29a37cd0d97687f76, pybind11::return_value_policy::reference_internal, "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("set_identity", autowig::method_decorator_98ad7e6dda285fe29a37cd0d97687f76);
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("set_identity", method_pointer_22d32bfd6c635510a02afd967240a041, pybind11::return_value_policy::reference_internal, "");
    ...
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("force_aligned_access", method_pointer_92e8bc51b5b65471a92bcae16bff8e42, pybind11::return_value_policy::copy, "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("force_aligned_access", method_pointer_06840a3e23a7526d8ba22a531bc93d38, pybind11::return_value_policy::reference_internal, "");
    ...
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("matrix", method_pointer_0e2e904fbba256629a3383e363838541, pybind11::return_value_policy::reference_internal, "");
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("matrix", autowig::method_decorator_0e2e904fbba256629a3383e363838541);
    class_188d9a4d2cfb562385c42fe005cf6a4c.def("matrix", method_pointer_3e8dbb6e60b45690a48389b344f523f7, pybind11::return_value_policy::copy, "");
