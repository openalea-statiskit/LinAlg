...
namespace autowig
{
    ...
    void method_decorator_22d32bfd6c635510a02afd967240a041(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > & instance, ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::Index  param_in_0, ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::Index  param_in_1, const class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > & param_out) { instance.setIdentity(param_in_0, param_in_1) = param_out; }
...
namespace boost
{
    template <> class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > const volatile * get_pointer<class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > const volatile >(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > > const volatile *c) { return c; }
}
    #endif
#endif
...
void wrapper_188d9a4d2cfb562385c42fe005cf6a4c()
{
    ...
    ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::Index  (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_bf27f693997c5cd1bd6b0ee4ed88e63b)() const = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::diagonalSize;
    ...
    class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > & (::Eigen::MatrixBase< ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::*method_pointer_22d32bfd6c635510a02afd967240a041)(::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::Index , ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::Index ) = &::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, -1, 1, 1, -1 > >::setIdentity;
