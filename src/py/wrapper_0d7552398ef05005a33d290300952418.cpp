...
namespace autowig
{
    void method_decorator_c1a12cb359ec5d988dc5ca777933d98d(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 > > & instance, class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 >  & param_out)     { instance.real() = param_out; }
    void method_decorator_9f27486d0b465d018496cc5e3dcb8cd2(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 > > & instance, class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 >  & param_out)     { instance.setIdentity() = param_out; }
    void method_decorator_44d79478cca55aa390a5e16112bd1942(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 >  & param_out)     { instance.setIdentity(param_in_0, param_in_1) = param_out; }
    void method_decorator_6aa243c1aeb45d13981092fbcf27d8e3(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 > > & instance, class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 >  & param_out)     { instance.forceAlignedAccess() = param_out; }
    void method_decorator_f0a83b3ff9735c1798bdd0511c4b1f0c(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 3, 1, 1, 3 > >  & param_out)     { instance.matrix() = param_out; }
}
