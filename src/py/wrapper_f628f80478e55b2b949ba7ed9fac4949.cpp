...
namespace autowig
{
    void method_decorator_aa3319fa7c83564ea6c0cbb568d368b8(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_35b3646dc57e5fc6aa790e29f3694202(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_7d6c7949999e5d96b4ef936b1cca82a5(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, long int  param_in_1, struct ::std::complex< double >  & param_out)     { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_09aba0e76ca15ef0b0dcfbd075560284(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_a70c03fe23e058c0915b7276a59ff133(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_8c771b3311a25abf9f6136141f1f528a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, long int  param_in_0, struct ::std::complex< double >  & param_out)     { instance.operator()(param_in_0) = param_out; }
    void method_decorator_c34d215a613e5c7fb8d05f3a4be6950a(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.x() = param_out; }
    void method_decorator_9aa21e3a889c5cb6822c3e0fb36415a0(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.y() = param_out; }
// TODO     void method_decorator_86d080cc940a5f568b04090c03f406dd(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.z() = param_out; }
// TODO     void method_decorator_461011881f2257ea80dabdf169915fab(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 > & instance, struct ::std::complex< double >  & param_out)     { instance.w() = param_out; }
}
...
// TODO // TODO     struct ::std::complex< double >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_86d080cc940a5f568b04090c03f406dd)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 >::z;
// TODO // TODO     struct ::std::complex< double >  & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 >::*method_pointer_461011881f2257ea80dabdf169915fab)() = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 2, 1, 0, 2, 1 >, 1 >::w;
...
// TODO // TODO     class_f628f80478e55b2b949ba7ed9fac4949.def("z", method_pointer_86d080cc940a5f568b04090c03f406dd, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_f628f80478e55b2b949ba7ed9fac4949.def("z", autowig::method_decorator_86d080cc940a5f568b04090c03f406dd);
// TODO // TODO     class_f628f80478e55b2b949ba7ed9fac4949.def("w", method_pointer_461011881f2257ea80dabdf169915fab, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_f628f80478e55b2b949ba7ed9fac4949.def("w", autowig::method_decorator_461011881f2257ea80dabdf169915fab);
