...
namespace autowig
{
    void method_decorator_b233fa0886055a33891564d9ff0aa815(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setConstant(param_in_0) = param_out; }
    void method_decorator_bae27bfe00645e72ab15a7991ff02eae(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, long int  param_in_0, struct ::std::complex< double >  const & param_in_1, struct ::std::complex< double >  const & param_in_2, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
    void method_decorator_54668748a53652df95f9a7c456243cab(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, struct ::std::complex< double >  const & param_in_0, struct ::std::complex< double >  const & param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setLinSpaced(param_in_0, param_in_1) = param_out; }
    void method_decorator_7589e3aeb6fa57a4b616d40529ada9eb(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setZero() = param_out; }
    void method_decorator_5258dd73a3365e0fa08f669ac4530867(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setOnes() = param_out; }
    void method_decorator_61c7f816289a5b01887b6868d61be3b3(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
    { instance.setRandom() = param_out; }
    void method_decorator_72d839ab3ee15a35917e851f5df54ea0(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & param_out)
...
void wrapper_005cba20c79551ba84602f02a9802109()
{
    ...
    class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_bae27bfe00645e72ab15a7991ff02eae)(long int , struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::setLinSpaced;
    class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_54668748a53652df95f9a7c456243cab)(struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::setLinSpaced;
    ...
    struct ::std::complex< double >  (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_6fcb69bf4832597c99b4a8390b55485f)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::minCoeff;
    struct ::std::complex< double >  (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_2fd578bcf0cb5719b494aeef68be121a)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::maxCoeff;
    ...
    bool  (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_2186f0d2fba75c1197ee47e0c0f4c254)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::all;
    bool  (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_de6e0a919f6d544ba8c0ccebe23ca61b)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::any;
    long int  (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, -1, -1, 0, -1, -1 > >::*method_pointer_96d14fe160bd5435a20948c602f2ed35)() const = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, -1, -1, 0, -1, -1 > >::count;
    ...
    class_005cba20c79551ba84602f02a9802109.def("set_lin_spaced", method_pointer_bae27bfe00645e72ab15a7991ff02eae, boost::python::return_internal_reference<>(), "");
    class_005cba20c79551ba84602f02a9802109.def("set_lin_spaced", autowig::method_decorator_bae27bfe00645e72ab15a7991ff02eae);
    class_005cba20c79551ba84602f02a9802109.def("set_lin_spaced", method_pointer_54668748a53652df95f9a7c456243cab, boost::python::return_internal_reference<>(), "");
    class_005cba20c79551ba84602f02a9802109.def("set_lin_spaced", autowig::method_decorator_54668748a53652df95f9a7c456243cab);
    ...
    class_005cba20c79551ba84602f02a9802109.def("min_coeff", method_pointer_6fcb69bf4832597c99b4a8390b55485f, "");
    class_005cba20c79551ba84602f02a9802109.def("max_coeff", method_pointer_2fd578bcf0cb5719b494aeef68be121a, "");
    ...
    class_005cba20c79551ba84602f02a9802109.def("all", method_pointer_2186f0d2fba75c1197ee47e0c0f4c254, "");
    class_005cba20c79551ba84602f02a9802109.def("any", method_pointer_de6e0a919f6d544ba8c0ccebe23ca61b, "");
    class_005cba20c79551ba84602f02a9802109.def("count", method_pointer_96d14fe160bd5435a20948c602f2ed35, "");
