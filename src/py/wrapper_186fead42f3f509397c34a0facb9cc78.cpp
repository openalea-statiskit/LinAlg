...
namespace autowig
{
    void method_decorator_cd53f80540e55875af2e6cb501c0588d(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >  & param_out)     { instance.base() = param_out; }
    void method_decorator_b78706708fbe5efbab7eca5f531f50fb(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, const float  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_9028293f86b057d3bea19d9cb0da1e5b(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, const float  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
// TODO     void method_decorator_2b28d8190a6b5613bbde3d43ca9e8187(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, float  const & param_in_1, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_9368ea3f43ba5179ad35eda01d952e8f(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, float  const & param_in_2, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO     void method_decorator_274025f9e02d507a8f98edb32dee246d(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setZero(param_in_0) = param_out; }
    void method_decorator_2e36afd15b725e5a812f998072ab412e(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setZero(param_in_0, param_in_1) = param_out; }
// TODO // TODO     void method_decorator_1c80b7454b7b505bb3051a92ea9a43b2(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_a29128bbecb35e29aba74edaafc99a36(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setOnes(param_in_0, param_in_1) = param_out; }
// TODO     void method_decorator_8a542c7cfffb5c568ec154bb7b0cf821(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_6d5a94cba95055778d6fa30e79a848dd(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & param_out)     { instance.setRandom(param_in_0, param_in_1) = param_out; }
}
...
// TODO     class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::*method_pointer_2b28d8190a6b5613bbde3d43ca9e8187)(long int , float  const &) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::setConstant;
...
// TODO     class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::*method_pointer_274025f9e02d507a8f98edb32dee246d)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::setZero;
...
// TODO     class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::*method_pointer_1c80b7454b7b505bb3051a92ea9a43b2)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::setOnes;
...
// TODO     class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::*method_pointer_8a542c7cfffb5c568ec154bb7b0cf821)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >::setRandom;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< float, 3, 3, 0, 3, 3 > > >, boost::noncopyable > class_186fead42f3f509397c34a0facb9cc78("_PlainObjectBase_186fead42f3f509397c34a0facb9cc78", "", boost::python::no_init);
...
// TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_constant", method_pointer_2b28d8190a6b5613bbde3d43ca9e8187, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_constant", autowig::method_decorator_2b28d8190a6b5613bbde3d43ca9e8187);
...
// TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_zero", method_pointer_274025f9e02d507a8f98edb32dee246d, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_zero", autowig::method_decorator_274025f9e02d507a8f98edb32dee246d);
...
// TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_ones", method_pointer_1c80b7454b7b505bb3051a92ea9a43b2, boost::python::return_internal_reference<>(), "");
// TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_ones", autowig::method_decorator_1c80b7454b7b505bb3051a92ea9a43b2);
...
// TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_random", method_pointer_8a542c7cfffb5c568ec154bb7b0cf821, boost::python::return_internal_reference<>(), "");
// TODO     class_186fead42f3f509397c34a0facb9cc78.def("set_random", autowig::method_decorator_8a542c7cfffb5c568ec154bb7b0cf821);
