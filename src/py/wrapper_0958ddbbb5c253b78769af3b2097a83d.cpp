...
namespace autowig
{
    void method_decorator_f466312c89ba514faa414c056e9e4b0a(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >  & param_out)     { instance.base() = param_out; }
    void method_decorator_d19613cee6985eaabdbca9d716636c37(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, long int  param_in_1, const int  & param_out)     { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_2eba272f32ce5b94ade9016d4219660c(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, const int  & param_out)     { instance.coeffRef(param_in_0) = param_out; }
// TODO     void method_decorator_2154c5a25b3a5ec0b39e05a0a0d0cf06(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, int  const & param_in_1, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setConstant(param_in_0, param_in_1) = param_out; }
    void method_decorator_0341db852ce454a69012797148c86208(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, long int  param_in_1, int  const & param_in_2, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setConstant(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO     void method_decorator_64da1a7ffcb056cd99f4f98a28ed8785(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setZero(param_in_0) = param_out; }
    void method_decorator_409ba293df36558583116891346b8daa(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setZero(param_in_0, param_in_1) = param_out; }
// TODO // TODO     void method_decorator_a305912414fc5e34a261cce8877b711a(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setOnes(param_in_0) = param_out; }
    void method_decorator_862608bf02fa5b93b05406ad2a8c7c77(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setOnes(param_in_0, param_in_1) = param_out; }
// TODO     void method_decorator_66de9ac8973b56eeb055273875df8ec9(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setRandom(param_in_0) = param_out; }
    void method_decorator_2d4370d285c2526d8f7c0f130bc6e774(class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & param_out)     { instance.setRandom(param_in_0, param_in_1) = param_out; }
}
...
// TODO     class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::*method_pointer_2154c5a25b3a5ec0b39e05a0a0d0cf06)(long int , int  const &) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::setConstant;
...
// TODO     class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::*method_pointer_64da1a7ffcb056cd99f4f98a28ed8785)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::setZero;
...
// TODO     class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::*method_pointer_a305912414fc5e34a261cce8877b711a)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::setOnes;
...
// TODO     class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 >  & (::Eigen::PlainObjectBase< ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::*method_pointer_66de9ac8973b56eeb055273875df8ec9)(long int ) = &::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >::setRandom;
    ...
    boost::python::class_< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > >, autowig::HeldType< class ::Eigen::PlainObjectBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > >, boost::python::bases< class ::Eigen::MatrixBase< class ::Eigen::Matrix< int, 2, 2, 0, 2, 2 > > >, boost::noncopyable > class_0958ddbbb5c253b78769af3b2097a83d("_PlainObjectBase_0958ddbbb5c253b78769af3b2097a83d", "", boost::python::no_init);
...
// TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_constant", method_pointer_2154c5a25b3a5ec0b39e05a0a0d0cf06, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_constant", autowig::method_decorator_2154c5a25b3a5ec0b39e05a0a0d0cf06);
...
// TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_zero", method_pointer_64da1a7ffcb056cd99f4f98a28ed8785, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_zero", autowig::method_decorator_64da1a7ffcb056cd99f4f98a28ed8785);
...
// TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_ones", method_pointer_a305912414fc5e34a261cce8877b711a, boost::python::return_internal_reference<>(), "");
// TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_ones", autowig::method_decorator_a305912414fc5e34a261cce8877b711a);
...
// TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_random", method_pointer_66de9ac8973b56eeb055273875df8ec9, boost::python::return_internal_reference<>(), "");
// TODO     class_0958ddbbb5c253b78769af3b2097a83d.def("set_random", autowig::method_decorator_66de9ac8973b56eeb055273875df8ec9);
