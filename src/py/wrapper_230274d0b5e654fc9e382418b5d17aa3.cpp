...
namespace autowig
{
    void method_decorator_de49d1a0208458c48f2c006db05198f2(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & param_out)     { instance.setConstant(param_in_0) = param_out; }
// TODO // TODO     void method_decorator_3740488d2b1e5b70a861e818f00e6a17(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > > & instance, long int  param_in_0, struct ::std::complex< double >  const & param_in_1, struct ::std::complex< double >  const & param_in_2, class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1, param_in_2) = param_out; }
// TODO // TODO // TODO // TODO     void method_decorator_2dfee3f20d235fb2864b4e1fe66b5be8(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > > & instance, struct ::std::complex< double >  const & param_in_0, struct ::std::complex< double >  const & param_in_1, class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & param_out)     { instance.setLinSpaced(param_in_0, param_in_1) = param_out; }
    void method_decorator_a3ba086c713156b79f5269e91df214d9(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & param_out)     { instance.setZero() = param_out; }
    void method_decorator_91aa4923708c56728cdb0f96a5361b47(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & param_out)     { instance.setOnes() = param_out; }
    void method_decorator_815692d56bbf51b889ed4ef395a10212(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > > & instance, class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & param_out)     { instance.setRandom() = param_out; }
    void method_decorator_b3a37d3dd7105e0bbc6c2195689bc86b(class ::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > > & instance, struct ::std::complex< double >  const & param_in_0, class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & param_out)     { instance.operator*=(param_in_0) = param_out; }
}
...
// TODO // TODO // TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 1, 4, 1, 1, 4 > >::*method_pointer_3740488d2b1e5b70a861e818f00e6a17)(long int , struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > >::setLinSpaced;
// TODO // TODO     class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 >  & (::Eigen::DenseBase< ::Eigen::Matrix< ::std::complex< double >, 1, 4, 1, 1, 4 > >::*method_pointer_2dfee3f20d235fb2864b4e1fe66b5be8)(struct ::std::complex< double >  const &, struct ::std::complex< double >  const &) = &::Eigen::DenseBase< class ::Eigen::Matrix< struct ::std::complex< double >, 1, 4, 1, 1, 4 > >::setLinSpaced;
...
// TODO // TODO     class_230274d0b5e654fc9e382418b5d17aa3.def("set_lin_spaced", method_pointer_3740488d2b1e5b70a861e818f00e6a17, boost::python::return_internal_reference<>(), "");
// TODO // TODO     class_230274d0b5e654fc9e382418b5d17aa3.def("set_lin_spaced", autowig::method_decorator_3740488d2b1e5b70a861e818f00e6a17);
// TODO     class_230274d0b5e654fc9e382418b5d17aa3.def("set_lin_spaced", method_pointer_2dfee3f20d235fb2864b4e1fe66b5be8, boost::python::return_internal_reference<>(), "");
// TODO     class_230274d0b5e654fc9e382418b5d17aa3.def("set_lin_spaced", autowig::method_decorator_2dfee3f20d235fb2864b4e1fe66b5be8);
