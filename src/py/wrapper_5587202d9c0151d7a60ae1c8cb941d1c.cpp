...
void wrapper_5587202d9c0151d7a60ae1c8cb941d1c()
{
    ...
    struct ::std::complex< double >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::*method_pointer_d64e0654eb7e5cc7b6c545a69d97d852)(long int ) const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::operator[];
    ...
    struct ::std::complex< double >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::*method_pointer_bf1a36f1a06c583bb1f9d80c486562da)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::x;
    struct ::std::complex< double >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::*method_pointer_a324c483a15f5927a8a8b4cac1d6e5d8)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::y;
    struct ::std::complex< double >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::*method_pointer_aa5e5153fb65523fba8e48a4bc462a86)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::z;
    struct ::std::complex< double >  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::*method_pointer_360a9ffe5f9b5cc5b313ab6302d1ca45)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< struct ::std::complex< double >, 3, 3, 0, 3, 3 >, 0 >::w;
    ...
    class_5587202d9c0151d7a60ae1c8cb941d1c.def("__getitem__", method_pointer_d64e0654eb7e5cc7b6c545a69d97d852, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    ...
    class_5587202d9c0151d7a60ae1c8cb941d1c.def("x", method_pointer_bf1a36f1a06c583bb1f9d80c486562da, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_5587202d9c0151d7a60ae1c8cb941d1c.def("y", method_pointer_a324c483a15f5927a8a8b4cac1d6e5d8, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_5587202d9c0151d7a60ae1c8cb941d1c.def("z", method_pointer_aa5e5153fb65523fba8e48a4bc462a86, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_5587202d9c0151d7a60ae1c8cb941d1c.def("w", method_pointer_360a9ffe5f9b5cc5b313ab6302d1ca45, boost::python::return_value_policy< boost::python::return_by_value >(), "");
