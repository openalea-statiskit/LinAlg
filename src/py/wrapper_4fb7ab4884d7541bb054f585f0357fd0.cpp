...
namespace autowig
{
    void method_decorator_42a00c0d12755098a95c522b9f3fdfb6(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)     { instance.real() = param_out; }
    void method_decorator_27546b5a524f5e918ac8de1818b1dc0a(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)     { instance.setIdentity() = param_out; }
    void method_decorator_41c9bd0eba295ec0ae732f8af60fc555(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, long int  param_in_0, long int  param_in_1, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)     { instance.setIdentity(param_in_0, param_in_1) = param_out; }
    void method_decorator_13c80fd373c4508b9cb9a8aa6711ebe1(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 >  & param_out)     { instance.forceAlignedAccess() = param_out; }
    void method_decorator_9096477fcbbd51c8a185c72d38b0d72d(class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > > & instance, class ::Eigen::MatrixBase< class ::Eigen::Matrix< double, 1, 2, 1, 1, 2 > >  & param_out)     { instance.matrix() = param_out; }
}
