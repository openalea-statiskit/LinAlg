...
void wrapper_afe331da4a5453b7a4e8518767008816()
{
    ...
    class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 >  const & (::Eigen::HouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_10351077ec12590bb516a06b6fa85805)() const = &::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::matrixQR;
    ...
    long int  (::Eigen::HouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_98fc866b0ad15b499db03313e90b7b03)() const = &::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::rows;
    long int  (::Eigen::HouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_30c55c2c2f585ece8b050cdcea2d67b9)() const = &::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::cols;
    class ::Eigen::Matrix< double, -1, 1, 0, -1, 1 >  const & (::Eigen::HouseholderQR< ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::*method_pointer_f5b0fd92791c573fa3268f5c6c7fe3d6)() const = &::Eigen::HouseholderQR< class ::Eigen::Matrix< double, -1, -1, 0, -1, -1 > >::hCoeffs;
