...
void wrapper_618a1499f152532c9e3ea326401bf4ea()
{
    ...
    class ::Eigen::Matrix< float, -1, 1, 0, -1, 1 >  (*function_pointer_618a1499f152532c9e3ea326401bf4ea)(class ::Eigen::Matrix< float, -1, -1, 0, -1, -1 >  const &, class ::Eigen::Matrix< float, -1, 1, 0, -1, 1 >  const &, enum ::ieigen::solver_type  const &) = ::ieigen::solve;
    boost::python::def("solve", function_pointer_618a1499f152532c9e3ea326401bf4ea, "");
}