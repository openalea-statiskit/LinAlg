...
void wrapper_e043b9d8921756618b8f79b3f29b422b()
{
    ...
    float  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 0 >::*method_pointer_a61a1ba7c2545d13ba407fe9fddc7550)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 0 >::z;
    float  const & (::Eigen::DenseCoeffsBase< ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 0 >::*method_pointer_67256138d5c55c9798419f7c3a609ac2)() const = &::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< float, 1, 2, 1, 1, 2 >, 0 >::w;
    ...
    class_e043b9d8921756618b8f79b3f29b422b.def("z", method_pointer_a61a1ba7c2545d13ba407fe9fddc7550, boost::python::return_value_policy< boost::python::return_by_value >(), "");
    class_e043b9d8921756618b8f79b3f29b422b.def("w", method_pointer_67256138d5c55c9798419f7c3a609ac2, boost::python::return_value_policy< boost::python::return_by_value >(), "");
