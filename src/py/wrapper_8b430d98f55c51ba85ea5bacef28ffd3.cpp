...
namespace autowig
{
    void method_decorator_818fd7a2723d54698a6a4db525c5b314(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.coeffRef(param_in_0, param_in_1) = param_out; }
    void method_decorator_9369ef462d755ed69cbe2548dbef1403(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.coeffRefByOuterInner(param_in_0, param_in_1) = param_out; }
    void method_decorator_c52472e259dc546db805435af9923255(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, long int  param_in_0, long int  param_in_1, const double  & param_out)
    { instance.operator()(param_in_0, param_in_1) = param_out; }
    void method_decorator_8357c3a673b8517ca9291f4b5dd32627(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, long int  param_in_0, const double  & param_out)
    { instance.coeffRef(param_in_0) = param_out; }
    void method_decorator_974c614641c059efa359c497500c1274(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, long int  param_in_0, const double  & param_out)
    { instance.operator[](param_in_0) = param_out; }
    void method_decorator_2695c5b4d2db5b35ac9da983408dd40d(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, long int  param_in_0, const double  & param_out)
    { instance.operator()(param_in_0) = param_out; }
    void method_decorator_66907f09ec09562f842a5795aca0db99(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, const double  & param_out)
    { instance.x() = param_out; }
    void method_decorator_0a62ff20f22a5cd9b3e0af9a2c3ec40d(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, const double  & param_out)
    { instance.y() = param_out; }
    void method_decorator_24eceba9c40055bfbd7f70abf82e2c5e(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, const double  & param_out)
    { instance.z() = param_out; }
    void method_decorator_be872cc5547e5b04952057836f1335fc(class ::Eigen::DenseCoeffsBase< class ::Eigen::Matrix< double, 1, 4, 1, 1, 4 >, 1 > & instance, const double  & param_out)
